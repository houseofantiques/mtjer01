...
},
{
  ...
  title: {
    ar: "قلادة من أحجار كريمة قديمة",
    en: "Vintage Gemstone Necklace",
    ku: "گەردەنەوەی بەردی بەهادار کۆن"
  },

  description: {
    ar: "قلادة أنتيك مصنوعة من أحجار كريمة طبيعية، يعود عمرها إلى ما لا يقل عن 40 سنة، بتناسق لوني مميز يعكس الطابع التراثي الأصيل.",
    en: "An antique necklace crafted from natural gemstones, dating back at least 40 years, featuring a harmonious color composition with a distinctive heritage character.",
    ku: "گەردەنەوەیەکی کۆن دروستکراو لە بەردی بەهادار سروشتی، تەمەنی لانیکەم ٤٠ ساڵە، بە ڕەنگاڵەیەکی هاوبەش و ڕەسەن."
  },
...
},
{
  ...
  name: {
    ar: "طبق كريستالي مزخرف يدويًا",
    en: "Hand-Decorated Crystal Plate",
    ku: "سحنێکی کریستالی نەخش‌دار بە دەست"
  },

  desc: {
    ar: "طبق كريستالي مزخرف بزخارف نباتية وهندسية ناعمة، يعكس طابعًا كلاسيكيًا مستوحى من الفنون الأوروبية القديمة. يتميز بتدرجات لونية هادئة وتفاصيل مرسومة يدويًا، ما يجعله قطعة مناسبة للعرض كتحفة فنية أو ضمن مجموعات الكريستال النادرة.",
    en: "A hand-decorated crystal plate featuring delicate floral and geometric motifs inspired by classic European art. Soft color tones and fine hand-painted details give the piece an elegant presence, ideal for display as a decorative artwork or as part of a rare crystal collection.",
    ku: "سحنێکی کریستالی بە نەخشە ڕووەکی و هندەسییە نرمانەکان، هەڵگرتووە لە هونەری ئەورووپی کلاسیکی. ڕەنگە ئارامەکان و وردەکارییە دەستییەکان ئەم پارچەیە دەکەن بە تحفەیەکی جوان بۆ پیشاندان یان بۆ کۆمەڵە کریستالە نادرەکان."
  },
...
price: "360,000 د.ع",
  ...
  keywords: "طبق كريستال, كريستال مزخرف, طبق زخرفي, تحف كريستالية, crystal plate, hand decorated crystal, vintage crystal, decorative glass plate, سحن کریستال, کریستالی نەخش‌دار, تحفی کریستالی"
},
{
  id: "HOA-CRY-243",
...
},
{
  ...
  name: {
    ar: "مجموعة قطع كريستال خضراء بغطاء",
    en: "Green Crystal Decorative Set with Stoppers",
