...
},
{
  ...
  name: {
    ar: "لوحة فنية مشهد سوق شرقي قديم",
    en: "Painting of an Old Eastern Market Scene",
    ku: "تابلۆیەکی هونەری لە بازاڕێکی کۆنی ڕۆژهەڵات"
  },

  desc: {
    ar: "لوحة فنية مرسومة يدويًا تُجسّد مشهدًا من الحياة اليومية في سوق شرقي قديم، حيث تظهر العمارة التقليدية، المآذن، الباعة، والعربات في تناغم بصري يعكس روح المدينة القديمة. استخدام الألوان الترابية والظلال الناعمة يمنح اللوحة عمقًا وهدوءًا، بينما تعكس التفاصيل الإنسانية أسلوب الحياة والتجارة في تلك الفترة. آثار الزمن الخفيفة على سطح اللوحة تؤكد قدمها وأصالتها، ما يجعلها قطعة فنية مناسبة للاقتناء، للعرض المتحفي، أو لإضفاء طابع تاريخي وثقافي على المساحات الكلاسيكية.",
    en: "A hand-painted artwork depicting a daily life scene from an old Eastern market, featuring traditional architecture, minarets, merchants, and carts in a harmonious composition that reflects the spirit of historic cities. The use of earthy tones and soft shadows adds depth and calmness, while the human details capture the rhythm of life and trade of the era. Subtle signs of age on the surface enhance its authenticity, making it suitable for collectors, museum-style display, or adding historical and cultural character to classic interiors.",
    ku: "تابلۆیەکی دەستنووسراو کە دیمەنێکی ژیانی ڕۆژانە لە بازاڕێکی کۆنی ڕۆژهەڵات پیشان دەدات، لەگەڵ بینای کۆن، منارەکان، فرۆشیاران و عەرەبانەکان. ڕەنگە خاکییەکان و سایە نرمانەکان قووڵی و ئارامی بە کارەکە دەدەن، و وردەکارییە مرۆییەکان ژیانی بازرگانی ئەو سەردەمە پیشان دەدەن. نیشانەکانی کات ڕەسەنبوونی تابلۆکە پشتڕاست دەکەن و بۆ پیشاندانی مۆزەخانەیی یان کۆمەڵەی هونەری گونجاوە."
  },

  dimensions: {
    ar: "الطول 90 سم × العرض 140 سم",
  ...
  images: [
    cld("hoa-art-275_k12dvy")
  ],

  keywords: "لوحة فنية قديمة, مشهد سوق شرقي, لوحة تراثية, تحف فنية, antique market painting, oriental street art, تابلۆی کۆن"
},
{
  id: "HOA-COP-280",

  category: { ar:"نحاس", en:"Copper", ku:"مسی" },

  name: {
    ar: "زوج فازات نحاس بتصميم كلاسيكي",
    en: "Pair of Classic Copper Vases",
    ku: "دوو فازەی مسی بە دیزاینی کلاسیکی"
  },

  desc: {
    ar: "زوج فازات مصنوعتان من النحاس بتصميم كلاسيكي متناسق، يتميز بالشكل الانسيابي والسطح المصقول الذي يحمل آثار الزمن الطبيعية. القطعتان متطابقتان بالحجم والشكل، ما يجعلهما مثاليتين للعرض المتوازن على الطاولات، الكونسولات، أو داخل الفترينات. تصلحان للديكور الكلاسيكي والشرقي، وتمنحان المكان حضورًا دافئًا وأنيقًا.",
    en: "A pair of copper vases featuring a balanced classic design with smooth curves and a naturally aged patina. The two pieces are matching in size and form, making them ideal for symmetrical display on tables, consoles, or inside display cabinets. Suitable for classic and oriental interiors, adding warmth and elegance to the space.",
    ku: "دوو فازەی مسی بە دیزاینێکی هاوسەنگ و کلاسیکی، بە شێوەیەکی نەرم و ڕووکارێک کە نیشانەکانی کات لەسەر دیارە. گونجاون بۆ پیشاندانی هاوسەنگ لەسەر مێز، کۆنسۆڵ یان ناو فاترینا، و بۆ دیکۆری کلاسیکی و ڕۆژهەڵاتی گونجاون."
  },

  dimensions: {
    ar: "الارتفاع التقريبي لكل فازة: 35 سم",
    en: "Approximate height per vase: 35 cm",
    ku: "بەرزی نزیکەی هەر فازەیەک: 35 سم"
  },
  ...
  images: [
    cld("hoa-cop-280_l7acvu")
  ],

  keywords: "فازات نحاس, زوج فازات, ديكور نحاسي, تحف نحاس, copper vases pair, antique copper, فازة كلاسيكية"
},
{
  id: "HOA-CRY-278",
  ...
  name: {
    ar: "فازة كرستال مرسومة يدويًا بمنظر طبيعي",
    en: "Hand-Painted Crystal Vase with Landscape Scene",
    ku: "فازەی کریستال دەست‌نەقشکراو بە دیمەنی سروشتی"
  },

  desc: {
    ar: "فازة كرستالية فاخرة مزينة برسم يدوي دقيق لمنظر طبيعي بأسلوب شرقي كلاسيكي، تجمع بين الجبال والأشجار والعمارة التقليدية. الإطار الزخرفي الأزرق المحيط بالفازة يعكس الطابع الآسيوي الأصيل، مع تنفيذ متقن وتوازن بصري واضح. قطعة مثالية للعرض المتحفي أو كعنصر ديكور مركزي يعبّر عن الذوق الرفيع.",
    en: "A refined crystal vase featuring a finely hand-painted landscape scene in a classic oriental style, depicting mountains, trees, and traditional architecture. The blue decorative border enhances its authentic Asian character, with balanced composition and skilled craftsmanship. Ideal as a museum-style display piece or a central decorative element.",
    ku: "فازەیەکی کریستالی بەنرخ کە بە دەست دیمەنێکی سروشتی بە شێوازی ڕۆژهەڵاتی کلاسیکی تێدا نوسراوە، گەورەیی شاخ، دارستان و بیناسازیی کۆن پیشان دەدات. چوارچێوەی شینە ڕازاوەکە ڕەنگدانێکی ڕەسەن پێدەدات و گونجاوە بۆ پیشاندانی مۆزەیی."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 32 سم",
    en: "Approximate height: 32 cm",
    ku: "بەرزی نزیکەیی: 32 سم"
  },
  ...
  images: [
    cld("hoa-cry-278_iwv04l")
  ],

  keywords: "فازة كرستال, كرستال مرسوم, فازة شرقية, تحف كرستالية, crystal vase, hand painted crystal"
},

{
  ...
  name: {
    ar: "قطعة كريستال روسي قيصري مرسومة يدويًا",
    en: "Imperial Russian Hand-Painted Crystal Jar",
    ku: "پارچەی کریستاڵی ڕووسی قیصەری بە دەست نەقشکراو"
  },

  desc: {
    ar: "قطعة كريستال فاخرة تعود للطراز القيصري الروسي، منفذة من كريستال شفاف عالي الجودة ومزينة برسم يدوي دقيق لزخارف نباتية وزهور باللونين الأزرق والذهبي. تتميز بغطاء متقن بتفاصيل كلاسيكية تعكس الذوق الأرستقراطي لتلك الحقبة. قطعة نادرة مناسبة للعرض المتحفي أو لمقتني التحف الراقية.",
    en: "A luxurious crystal piece in the Imperial Russian style, crafted from high-quality clear crystal and adorned with finely hand-painted floral and botanical motifs in blue and gold tones. The elegant lid features classic detailing reflecting aristocratic taste of the era. A rare item ideal for museum display or distinguished antique collectors.",
    ku: "پارچەیەکی کریستاڵی نایاب بە شێوازی قیصەری ڕووس، لە کریستاڵی ڕوون و بەرزجۆر دروستکراوە و بە دەست ڕازاوە بە نەقشی دارستانی و گوڵی شین و زەرد. گرتەکە هۆنراوە بە وردەکاری کلاسیکی، گونجاو بۆ پیشاندانی مۆزەیی یان کۆکراوەی نادر."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 38 سم",
    en: "Approximate height: 38 cm",
    ku: "بەرزی نزیکەیی: 38 سم"
  },
  ...
  images: [
    cld("hoa-cry-286_z4bzfu")
  ],

  keywords: "كريستال روسي, قيصري, كريستال مرسوم يدوي, تحف قيصرية, imperial russian crystal, hand painted crystal, antique crystal"
},
{
  id: "HOA-CRY-285",
  ...
  name: {
    ar: "طبق عرض كرستال مزخرف – عمل يدوي",
    en: "Handcrafted Decorative Crystal Display Plate",
    ku: "قاپی پیشاندانی کریستال – کارێکی دەستی"
  },

  desc: {
    ar: "طبق عرض دائري مصنوع يدويًا من الكرستال، يتميز بزخارف هندسية شعاعية دقيقة منفذة بحرفية عالية تعكس الذوق الكلاسيكي الراقي. قطعة مثالية للعرض الجداري أو على الحوامل، وتناسب المساحات الفاخرة والمجموعات المتحفية.",
    en: "A circular decorative display plate handcrafted from crystal, featuring finely detailed radial geometric patterns that reflect refined classical taste and high craftsmanship. Ideal for wall display or stands, suitable for elegant interiors and museum-style collections.",
    ku: "قاپێکی پیشاندانی بازنەیی لە کریستال دروستکراو بە دەست، خاوەن نەقشی هندەسیی ورد کە پیشەسازیی بەرز و چێژی کلاسیکی پیشان دەدات. گونجاوە بۆ پیشاندانی دیواری یان لەسەر ستاند."
  },

  dimensions: {
    ar: "القطر التقريبي: 40 سم",
    en: "Approximate diameter: 40 cm",
    ku: "پانی نزیکەیی: 40 سم"
  },
  ...
  images: [
    cld("hoa-cry-285_woez4l")
  ],

  keywords: "طبق كرستال, عمل يدوي, طبق عرض, تحف كرستالية, handcrafted crystal plate, decorative crystal"
},

{
  ...
  name: {
    ar: "طبق كرستال مزخرف – رسم يدوي",
    en: "Hand-Painted Decorative Crystal Plate",
    ku: "قاپی کریستال نەقاشی‌کراو بەدەست"
  },

  desc: {
    ar: "طبق كرستالي دائري مخصص للعرض، مزخرف برسومات نباتية وهندسية متناظرة منفذة بالكامل بالرسم اليدوي. يتميز بنقاء المادة ودقة التفاصيل مع توازن بصري أنيق، ما يجعله قطعة مثالية للعرض المتحفي أو ضمن مجموعات التحف الراقية.",
    en: "A round decorative crystal plate designed for display, featuring symmetrical floral and geometric hand-painted motifs. Distinguished by material clarity, fine detailing, and elegant visual balance, making it ideal for museum-style display or refined antique collections.",
    ku: "قاپێکی کریستالی بازنەیی بۆ پیشاندان، بە نەقشی ڕووەکی و هندەسی هاوسەنگ کە بە تەواوی بە دەست نەقشکراوە. پاکی ماددە و وردەکارییەکان وای کردووە بۆ پارچەیەکی گونجاو بۆ پیشاندانی مۆزەیی."
  },

  dimensions: {
    ar: "القطر التقريبي: 38 سم",
    en: "Approximate diameter: 38 cm",
    ku: "پانی نزیکەیی: 38 سم"
  },
  ...
  images: [
    cld("hoa-cry-279_aksogt")
  ],

  keywords: "طبق كرستال, رسم يدوي, قطع عرض, تحف فنية, crystal plate, hand painted crystal"
},
{
  id: "HOA-CRY-282",
  ...
  name: {
    ar: "فازة كرستال أسطوانية مزخرفة بحروف عربية",
    en: "Cylindrical Crystal Vase with Arabic Calligraphy",
    ku: "فازەی کریستالی ستوونی بە نووسینی عەرەبی"
  },

  desc: {
    ar: "فازة كرستال أسطوانية أنيقة مزينة بحروف عربية منفذة بأسلوب فني حر، تمتزج فيها درجات لونية هادئة مع ملمس كرستالي ناعم يعكس الحرفية العالية. قطعة ذات طابع روحي وفني، مناسبة للعرض المتحفي أو كعنصر ديكور يعبر عن الهوية الثقافية والذوق الرفيع.",
    en: "An elegant cylindrical crystal vase adorned with free-form Arabic calligraphy, blending soft earthy tones with a smooth crystal texture that reflects refined craftsmanship. A spiritual and artistic piece, ideal for museum-style display or as a cultural decorative accent.",
    ku: "فازەیەکی کریستالی ستوونی کە بە نووسینی عەرەبی بە شێوازی هونەری ئازاد ڕازاوە، ڕەنگە ئارامەکان لەگەڵ تێکسچەری نرمی کریستال تێکەڵبوون. گونجاوە بۆ پیشاندانی مۆزەیی یان دیکۆری کە ناسنامەی کولتووری پیشان دەدات."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 28 سم",
    en: "Approximate height: 28 cm",
    ku: "بەرزی نزیکەیی: 28 سم"
  },
  ...
  images: [
    cld("hoa-cry-282_xlvs7g")
  ],

  keywords: "فازة كرستال, فازة بحروف عربية, تحف فنية, كرستال مزخرف, crystal vase, arabic calligraphy crystal, decorative crystal"
},
{
  id: "HOA-CRY-289",
  ...
  name: {
    ar: "طبق عرض كرستال مزخرف – زخارف كلاسيكية",
    en: "Decorative Crystal Display Plate with Classic Motifs",
    ku: "قاپی پیشاندانی کریستالی بە نەقشە کلاسیکییەکان"
  },

  desc: {
    ar: "طبق عرض كرستال دائري مزخرف بزخارف نباتية متناظرة بأسلوب كلاسيكي راقٍ، منفذ بدقة عالية وتوازن بصري واضح. تتداخل الألوان الهادئة مع التفاصيل الدقيقة لتمنح القطعة طابعًا متحفيًا فخمًا، يجعلها مثالية للعرض على الحوامل أو ضمن مجموعات التحف الراقية.",
    en: "A circular crystal display plate adorned with symmetrical floral motifs in an elegant classic style. Crafted with fine precision and visual balance, featuring soft tones and intricate details that give it a refined museum-quality presence, ideal for stand display or high-end decorative collections.",
    ku: "قاپێکی پیشاندانی کریستالی بازنەیی کە بە نەقشە ڕووەکی هاوسەنگ بە شێوازی کلاسیکی ڕازاوە. وردەکاریی بەرز و هاوسەنگی بینینی هەیە، گونجاوە بۆ پیشاندانی مۆزەیی یان کۆمەڵەی شتە دیکۆرییە فاخراکان."
  },
  ...
  images: [
    cld("hoa-cry-289_lzczli")
  ],

  keywords: "طبق كرستال, طبق عرض, تحف كرستالية, زخارف كلاسيكية, crystal display plate, decorative crystal, classic crystal plate"
},
{
  id: "HOA-CRY-287",
  ...
  name: {
    ar: "طبق عرض كرستال مزخرف – منظر طبيعي كلاسيكي",
    en: "Decorative Crystal Display Plate with Classic Scenic Motif",
    ku: "قاپی پیشاندانی کریستالی بە دیمەنی کلاسیکی سروشتی"
  },

  desc: {
    ar: "طبق عرض كرستال مزخرف برسومات كلاسيكية باللون الأزرق، يتوسطه مشهد طبيعي ريفي بأسلوب أوروبي قديم، ومحاط بإطار زخرفي غني بالتفاصيل. يتميز بتوازن بصري وأناقة عالية، ما يجعله قطعة مثالية للعرض المتحفي أو ضمن مجموعات التحف الكلاسيكية الراقية.",
    en: "A decorative crystal display plate adorned with classic blue scenic artwork, featuring a central rural landscape in an old European style. Framed with richly detailed ornamental borders, offering refined elegance and visual harmony—ideal for museum-style display or premium antique collections.",
    ku: "قاپێکی پیشاندانی کریستالی کە بە نەقشەی کلاسیکی شین ڕازاوە، دیمەنێکی گوندی بە شێوازی ئەوروپی کۆن لە ناوەڕاستیدا پیشان دەدات. چوارچێوەیەکی پڕ وردەکاری هەیە و گونجاوە بۆ پیشاندانی مۆزەیی یان کۆمەڵەی شتە دیکۆرییە کلاسیکییەکان."
  },

  dimensions: {
    ar: "الأبعاد التقريبية: 34 × 34 سم",
    en: "Approximate dimensions: 34 × 34 cm",
    ku: "قەبارەی نزیکەیی: 34 × 34 سم"
  },
  ...
  images: [
    cld("hoa-cry-287_rrqj2d")
  ],

  keywords: "طبق كرستال, طبق عرض, تحف كرستالية, نقش أزرق, تحف أوروبية, crystal display plate, blue scenic plate, antique crystal"
},
{
  id: "HOA-FINE-288",
  ...
  name: {
    ar: "منحوتة عربة حربية رومانية – نحت كلاسيكي",
    en: "Classical Roman Chariot Sculpture",
    ku: "پەیکەرسازی عەرەبەی جەنگی ڕۆمانی – شێوازی کلاسیکی"
  },

  desc: {
    ar: "منحوتة فنية مجسّمة تمثل عربة حربية رومانية يجرّها حصان، منفذة بأسلوب كلاسيكي دقيق يبرز تفاصيل الحركة والعضلات والملابس العسكرية. العمل يعكس روح الفن الأوروبي الكلاسيكي ويُقدّر عمره التقريبي بنحو 70 عامًا، ما يجعله قطعة مميزة لهواة الاقتناء والعرض المتحفي.",
    en: "A sculptural artwork depicting a Roman war chariot drawn by a horse, executed in a refined classical style highlighting movement, anatomy, and military attire. Estimated to be approximately 70 years old, this piece reflects European classical artistry and is ideal for collectors and museum-style displays.",
    ku: "پەیکەرسازییەکی هونەری کە عەرەبەیەکی جەنگی ڕۆمانی بە ئەسپێک ڕاکێشراو پیشان دەدات، بە شێوازی کلاسیکی ورد کاری کراوە و جوڵە، ماسولکە و جلی سەربازی تێدا دیارە. تەمەنی نزیکەیی 70 ساڵ هەیە و گونجاوە بۆ کۆلەکتۆر و پیشاندانی مۆزەیی."
  },

  dimensions: {
    ar: "الطول التقريبي: 42 سم",
    en: "Approximate length: 42 cm",
    ku: "درێژی نزیکەیی: 42 سم"
  },

  age: {
    ar: "العمر التقريبي: 70 سنة",
    en: "Approximate age: 70 years",
    ku: "تەمەنی نزیکەیی: 70 ساڵ"
  },
  ...
  images: [
    cld("hoa-fine-288_zpc2jh")
  ],

  keywords: "منحوتة كلاسيكية, عربة رومانية, تمثال أنتيك, أعمال فنية قديمة, classical sculpture, roman chariot statue, antique figurine"
},
{
  id: "HOA-FINE-284",

  category: {
    ar: "أعمال فنية جدارية",
    en: "Wall Art",
    ku: "هونەری دیواری"
  },

  name: {
    ar: "زوج أقنعة جدارية خشبية – نحت يدوي",
    en: "Pair of Hand-Carved Wooden Wall Masks",
    ku: "دوو ماسکی دیواری دار – نەقشی دەستی"
  },

  desc: {
    ar: "عمل فني جداري مكوّن من زوج أقنعة خشبية منحوتة يدويًا بأسلوب إفريقي تعبيري. تتميز القطع بشكلها الطولي والزخارف المحفورة على السطح، مع طابع فني بدائي يعكس روح الفن القبلي. مناسبة للتعليق الجداري وإضفاء طابع فني جريء على المساحات الداخلية.",
    en: "A wall art piece consisting of a pair of hand-carved wooden masks in an expressive African-inspired style. The elongated form and engraved surface patterns give the piece a bold tribal character, ideal for wall display and artistic interior accents.",
    ku: "کارێکی هونەری دیواری پێکهاتوو لە دوو ماسکی دارین کە بە دەست نەقشکراون، بە شێوازی هونەری ئەفریقی. شێوەی درێژ و نەقشە هەڵکەندراوەکان ڕووحی هونەری قبیلەیی پیشان دەدات و گونجاوە بۆ هەڵواسینی دیواری."
  },

  dimensions: {
    ar: "الطول التقريبي لكل قطعة: 55 سم",
    en: "Approximate height per piece: 55 cm",
    ku: "درێژی نزیکەیی بۆ هەر پارچەیەک: 55 سم"
  },
  ...
  images: [
    cld("hoa-fine-284_ig8hl8")
  ],

  keywords: "أقنعة خشبية, فن جداري, نحت يدوي, ديكور جداري, wooden masks, wall art, hand carved wood"
},
{
  id: "HOA-FINE-270",
  ...
  name: {
    ar: "ساعة فنية بتمثال رومانسي كلاسيكي",
    en: "Classic Romantic Figurative Art Clock",
    ku: "کاتژمێری هونەری لەگەڵ پەیکەری ڕۆمانسی کلاسیکی"
  },

  desc: {
    ar: "عمل فني يجمع بين ساعة تناظرية وتمثال كلاسيكي يصوّر مشهدًا رومانسيًا بأسلوب أوروبي تقليدي. منفذ بعناية في التفاصيل والتكوين، ويُعد قطعة فنية مناسبة للعرض الداخلي ضمن المساحات ذات الطابع الكلاسيكي أو التراثي.",
    en: "An artistic piece combining an analog clock with a classic figurative sculpture depicting a romantic scene in a traditional European style. Crafted with attention to detail and composition, suitable for refined interior artistic display.",
    ku: "کارێکی هونەری کە کاتژمێرێکی ئەنالۆگ لەگەڵ پەیکەرێکی ڕۆمانسی کلاسیکی تێکەڵ دەکات، بە وردەکاری و ڕێکخستنی جوان، گونجاوە بۆ پیشاندانی هونەری ناوخۆ."
  },
  ...
  images: [
    cld("hoa-fine-270_kwmmw7")
  ],

  keywords: "عمل فني, ساعة فنية, تمثال كلاسيكي, أعمال فنية, art clock, figurative artwork"
},
{
  id: "HOA-FINE-274",
  ...
  name: {
    ar: "عمل فني مجسّم لطفلين على أرجوحة",
    en: "Figurative Artwork of Children on a Swing",
    ku: "کاری هونەری پەیکەری منداڵان لەسەر هەڵمەت"
  },

  desc: {
    ar: "عمل فني مجسّم يجسّد مشهدًا طفوليًا رقيقًا لطفلين على أرجوحة، منفذ بأسلوب أوروبي كلاسيكي مع عناية واضحة بالتفاصيل والتكوين. قطعة مناسبة للعرض الفني الداخلي وتنسجم مع المساحات ذات الطابع الكلاسيكي أو الرومانسي.",
    en: "A figurative artwork depicting a delicate childhood scene of two children on a swing, executed in a classic European style with attention to detail and composition. Suitable for artistic interior display.",
    ku: "کارێکی هونەری پەیکەری کە دیمەنێکی نرمی منداڵان لەسەر هەڵمەت پیشان دەدات، بە شێوازی کلاسیکی ئەورووپی و وردەکاریی ڕێک‌خراو."
  },
  ...
  images: [
    cld("hoa-fine-274_qe54px")
  ],

  keywords: "عمل فني, تمثال فني, نحت, أعمال فنية, figurative art, sculpture artwork"
},
{
  id: "HOA-FURN-271",
  ...
  name: {
    ar: "ساعة جدارية خشبية – تصميم بريطاني",
    en: "British Design Wooden Wall Clock",
    ku: "کاتژمێری دیواری دارین – دیزاینی بەریتانی"
  },

  desc: {
    ar: "ساعة جدارية خشبية طويلة بتصميم بريطاني كلاسيكي، تتميز بزخارف محفورة يدويًا وهيكل أنيق مع بندول نحاسي خلف واجهة زجاجية. قطعة أثاث فاخرة تضيف حضورًا قويًا للمساحات الكلاسيكية والمداخل الواسعة.",
    en: "A tall wooden wall clock in a classic British design, featuring hand-carved details and an elegant structure with a brass pendulum behind a glass panel. A refined furniture piece that adds strong character to classic interiors and spacious halls.",
    ku: "کاتژمێرێکی دیواری درێژ لە دار، بە دیزاینێکی کلاسیکی بەریتانی، خاوەن وردەکاریی تاشراوی دەستی و پێوانەیەکی جوان لەگەڵ پەندۆڵی مەسی لە پشت شیشەدا. پارچەیەکی کەلوپەلی نایاب."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 190 سم",
  ...
  images: [
    cld("hoa-furn-271_ik0j6i")
  ],

  keywords: "ساعة جدارية, أثاث كلاسيكي, ساعة خشب, تصميم بريطاني, wall clock furniture, british wall clock"
},
{
  id: "HOA-FURN-269",
  ...
  name: {
    ar: "طاولة عرض خشبية كلاسيكية",
    en: "Classic Wooden Display Table",
    ku: "مێزی پیشاندانی دارین کلاسیکی"
  },

  desc: {
    ar: "طاولة عرض خشبية بتصميم كلاسيكي أنيق، تتميز بأرجل مستقيمة مع زخارف محفورة خفيفة وحواف متوازنة. مناسبة لعرض التحف، الفازات أو القطع الفنية، وتعد قطعة أثاث عملية تضيف لمسة فخامة للمساحات الداخلية.",
    en: "A classic wooden display table featuring a refined design with straight legs, subtle carved details, and balanced proportions. Ideal for displaying antiques, vases, or art pieces, adding an elegant furniture touch to interior spaces.",
    ku: "مێزێکی پیشاندانی دارین بە شێوازی کلاسیکی، خاوەن لاقی ڕاست و وردەکاریی تاشراوی ناسک. گونجاوە بۆ پیشاندانی شوێنەوار، فازە یان پارچەی هونەری."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 75 سم",
  ...
  images: [
    cld("hoa-furn-269_f8leqh")
  ],

  keywords: "طاولة خشب, طاولة عرض, أثاث كلاسيكي, طاولة تحف, wooden display table, classic furniture"
},
{
  id: "HOA-FURN-273",
  ...
  name: {
    ar: "مغسلة خشبية كلاسيكية مع مرآة وحوض خزف",
    en: "Classic Wooden Washstand with Mirror and Ceramic Basin",
    ku: "دەستشووی دارین کلاسیکی لەگەڵ ئاوینە و حەوزی سەرامیک"
  },

  desc: {
    ar: "مغسلة خشبية قائمة بذاتها بتصميم كلاسيكي أنيق، تضم حوض خزف وإناء خزفي مع مرآة مدمجة. تتميز بتفاصيل نجارة دقيقة وبنية متوازنة، وتعكس أسلوب الحياة الأوروبية القديمة. قطعة نادرة تجمع بين الوظيفة والجمال، مثالية للعرض في المساحات التراثية أو كقطعة أثاث فنية مميزة.",
    en: "A freestanding classic wooden washstand featuring a ceramic basin, matching pitcher, and integrated mirror. Crafted with refined woodworking details and balanced proportions, reflecting traditional European lifestyle. A rare piece تجمعing functionality with aesthetic value, ideal for heritage interiors or artistic furniture display.",
    ku: "دەستشوویەکی دارینی سەربەخۆ بە شێوازی کلاسیکی، حەوز و ئینای سەرامیکی لەگەڵ ئاوینەی پێکەوە. وردەکاریی دارکاریی نازک و شێوەی هاوسەنگی هەیە، گونجاوە بۆ شوێنە مێژووییەکان یان وەک کەلوپەلی هونەری تایبەت."
  },

  dimensions: {
    ar: "الارتفاع التقريبي: 120 سم",
    en: "Approximate height: 120 cm",
    ku: "بەرزی نزیکەیی: 120 سم"
  },
  ...
  images: [
  cld("hoa-furn-273_f0a9hi")
],


  keywords: "مغسلة خشب, مغسلة قديمة, أثاث كلاسيكي, مغسلة مع مرآة, wooden washstand, antique furniture"
},
{
  id: "HOA-FURN-268",
  ...
  name: {
    ar: "طقم جلوس أرضي خشبي منحوت (كرسيان مع طاولة)",
    en: "Carved Wooden Floor Seating Set (Two Chairs with Table)",
    ku: "سێتی دانیشتنەوەی زەوی لە دار تراشراو (دوو کورسی و مێز)"
  },

  desc: {
    ar: "طقم جلوس أرضي فاخر مصنوع من الخشب المنحوت يدويًا، يضم كرسيين أرضيين مع طاولة دائرية متناسقة. يتميز بزخارف نباتية دقيقة وحرفية عالية تعكس الطابع الشرقي الكلاسيكي. قطعة مميزة للمجالس الراقية والمساحات التراثية.",
    en: "A luxurious floor seating set handcrafted from carved wood, consisting of two floor chairs and a matching round table. Features intricate floral carvings and high craftsmanship, reflecting a classic oriental character. Ideal for elegant majlis settings and heritage interiors.",
    ku: "سێتێکی دانیشتنەوەی زەوی لە دار بە دەست تراشراو، پێکهاتوو لە دوو کورسی و مێزێکی بازنەیی. نەقشی گیای ورد و پیشەسازیی بەرز نیشان دەدات، گونجاوە بۆ شوێنە فەخەم و مێژووییەکان."
  },

  dimensions: {
    ar: "طقم جلوس أرضي (كرسيان + طاولة)",
    en: "Floor seating set (2 chairs + table)",
    ku: "سێتی دانیشتنەوەی زەوی (دوو کورسی + مێز)"
  },
  ...
  images: [
    cld("hoa-furn-268_dwufuq")
  ],

  keywords: "جلسة أرضية, كراسي أرضية, طاولة أرضية, أثاث خشب منحوت, floor seating set, carved wooden furniture"
},
{
  id: "HOA-FURN-290",
  ...
  name: {
    ar: "مكتبة أرضية خشبية محفورة يدويًا",
    en: "Hand-Carved Wooden Floor Library",
    ku: "کتێبخانەی سەر زەوی دارینی دەست‌هەڵکێشراو"
  },

  desc: {
    ar: "مكتبة أرضية كبيرة مصنوعة من الخشب المحفور يدويًا بالكامل، تتميز بزخارف نباتية دقيقة وأبواب خشبية مزخرفة بتفاصيل تراثية غنية. قطعة قائمة بذاتها بكتلة قوية وحضور فخم، تجمع بين الاستخدام العملي والقيمة الفنية العالية. مناسبة للمساحات الواسعة، البيوت التراثية، أو القاعات الثقافية الراقية.",
    en: "A large freestanding wooden library crafted entirely with hand carving, featuring intricate floral motifs and richly decorated wooden doors. A solid floor-standing piece with a strong presence, combining practical storage with high artistic value. Ideal for spacious interiors, heritage homes, or refined cultural halls.",
    ku: "کتێبخانەیەکی گەورەی سەر زەوی لە دار دروستکراوە بە دەست، خاوەن نەقشی ڕووەکی ورد و دەرگاکانی پڕ لە وردەکاری مێژوویی. پارچەیەکی سەربەخۆ و فەخم، گونجاوە بۆ شوێنە فراوان و کەلتوورییەکان."
  },

  dimensions: {
    ar: "العرض التقريبي: 3.5 متر",
  ...
  images: [
    cld("hoa-furn-290_k4f8sb")
  ],

  keywords: "مكتبة خشب, مكتبة أرضية, خشب محفور يدوي, أثاث تراثي, hand carved wooden library, antique furniture"
},
{
  id: "HOA-FURN-291",
  ...
  name: {
    ar: "فاترينا خشبية أرضية بواجهات زجاج",
    en: "Wooden Floor Display Cabinet with Glass Panels",
    ku: "فاترینای دارینی سەر زەوی لەگەڵ شیشە"
  },

  desc: {
    ar: "فاترينا خشبية أرضية بتصميم كلاسيكي، مزودة بواجهات زجاجية علوية لعرض التحف والمقتنيات، مع أدراج سفلية محفورة بنقوش شعاعية دقيقة. قطعة متوازنة تجمع بين العرض والتخزين، مناسبة لعرض التحف، الأواني، أو المجموعات التراثية داخل المساحات الراقية.",
    en: "A classic wooden floor-standing display cabinet featuring upper glass-front sections for showcasing collectibles, and lower drawers carved with refined radial patterns. A balanced piece combining display and storage, ideal for antiques, vessels, or heritage collections.",
    ku: "فاترینایەکی دارینی سەر زەوی بە شێوازی کلاسیکی، بەشی سەرەوەی شیشە بۆ پیشاندانی شتە نادرەکان و خانەکانی خوارەوە بە نەقشی ورد. گونجاوە بۆ پیشاندانی کۆمەڵە مێژووییەکان."
  },
  ...
  images: [
    cld("hoa-furn-291_cgi2hb")
  ],

  keywords: "فاترينا خشب, فاترينا عرض, خزانة عرض خشبية, أثاث كلاسيكي, wooden display cabinet, antique furniture"
},
{
  id: "HOA-FURN-281",
  ...
  name: {
    ar: "فاترينا خشبية أرضية مزدوجة بواجهات زجاجية",
    en: "Double Wooden Floor Display Cabinet with Glass Doors",
    ku: "فاترینای دارینی دووبەش سەر زەوی لەگەڵ دەرگای شیشە"
  },

  desc: {
    ar: "فاترينا خشبية أرضية كبيرة بتصميم كلاسيكي فاخر، مزودة بواجهات زجاجية مزدوجة لعرض التحف والأواني الزجاجية، مع أدراج سفلية للتخزين. تتميز بتاج علوي منحوت يدويًا وتفاصيل نجارة دقيقة، ما يجعلها قطعة أثاث فنية مخصصة للمساحات الراقية والمجموعات التراثية.",
    en: "A large classic wooden floor-standing display cabinet with double glass doors for showcasing antiques and glassware, complemented by lower storage drawers. Features a hand-carved upper crown and refined woodworking details, making it a statement piece for elegant and heritage interiors.",
    ku: "فاترینایەکی گەورەی دارینی سەر زەوی بە شێوازی کلاسیکی، بە دوو دەرگای شیشە بۆ پیشاندانی شتە نادرەکان، لەگەڵ خانەی خوارەوە بۆ هەڵگرتن. خاوەن تاجێکی دەست‌نەقشکراوە."
  },
  ...
  images: [
    cld("hoa-furn-281_kgpksb")
  ],

  keywords: "فاترينا خشب, فاترينا عرض, خزانة عرض, أثاث كلاسيكي, فاترينا أرضية, wooden display cabinet, antique furniture"
},
{
  id: "HOA-FURN-292",
  ...
  name: {
    ar: "محمل عروس إنكليزي مطعّم بالسيراميك",
    en: "English Bridal Chest with Ceramic Inlays",
    ku: "محملی بووکێکی ئینگلیزی بە سێرامیک"
  },

  desc: {
    ar: "محمل عروس خشبي أرضي بتصميم إنكليزي تقليدي، مطعّم بزخارف سيراميك يدوية ملوّنة. يتميز بواجهة غنية بالتفاصيل الهندسية والنباتية، ويُستخدم لحفظ مستلزمات العروس أو كقطعة أثاث تراثية فنية نادرة تضيف طابعًا تاريخيًا راقيًا للمكان.",
  ...
  images: [
    cld("hoa-furn-292_flpnso")
  ],

  keywords: "محمل عروس, صندوق عروس, أثاث تراثي, أثاث إنكليزي, محمل خشب, ceramic inlay furniture, bridal chest"
},
{
  id: "HOA-WOOD-277",
  ...
  name: {
    ar: "صندوق إكسسوارات خشبي مطعّم بالنحاس مع درج داخلي",
    en: "Wooden Accessory Box with Brass Inlay and Inner Drawer",
    ku: "سندوقی دارینی بۆ ئاکسسوار، پێچراو بە مۆر و داری ناوخۆ"
  },

  desc: {
    ar: "صندوق إكسسوارات خشبي فاخر، مصنوع بدقة عالية، مطعّم بتفاصيل نحاسية يدوية، ويحتوي على درج داخلي للتقسيم والتنظيم. مبطّن من الداخل بقماش زخرفي أنيق، ما يجعله قطعة فنية عملية وجمالية في آن واحد.",
    en: "A refined wooden accessory box crafted with high precision, featuring handcrafted brass inlays and an inner drawer for organized storage. Lined with decorative fabric inside, combining functionality with artistic elegance.",
    ku: "سندوقێکی دارینی فاخەر، بە وردەکاریی مۆری دەستی، خاوەن داری ناوخۆ بۆ ڕێکخستن. ناوەوەی بە پارچەی ڕازاوە پوشراوە، گونجاو بۆ پیشاندان و بەکارهێنان."
  },

  dimensions: {
    ar: "الأبعاد التقريبية: 30 × 20 × 15 سم",
    en: "Approximate dimensions: 30 × 20 × 15 cm",
    ku: "قەبارەی نزیکەیی: 30 × 20 × 15 سم"
  },
  ...
  images: [
    cld("hoa-wood-277_os8l2k"),
    cld("hoa-wood-277-1_e6oran"),
    cld("hoa-wood-277-2_x8mylw")
  ],

  keywords: "صندوق خشبي, صندوق اكسسوارات, اعمال فنية خشب, brass inlay box, wooden jewelry box"
},
{
  id: "HOA-ART-312",
  ...
  name: {
    ar: "لوحة جسد أنثوي – للفنان أوميد (1998)",
    en: "Female Figure Study – by Omid (1998)",
    ku: "تابلۆی جەستەی ژن – کاری Omid (1998)"
  },

  desc: {
    ar: "لوحة أصلية مرسومة بأسلوب سكتش مائي تعبيري لدراسة جسد أنثوي. تحمل توقيع الفنان «أوميد» وتاريخ 1998، وتتميز بضربات فرشاة سريعة وتدرجات لونية ناعمة بين الأحمر والبيج على الورق. العمل يعكس أسلوب دراسات الجسد الكلاسيكية المستخدمة في المدارس الفنية الأكاديمية، ويعد قطعة فنية مميزة مناسبة للعرض في صالات الفن أو المساحات الداخلية ذات الطابع الثقافي.",

    en: "An original watercolor sketch depicting a female figure study. The artwork is signed by the artist “Omid” and dated 1998. It features expressive brush strokes and soft tonal transitions between red and beige on paper. The piece reflects classical academic figure study traditions and is suitable for display in art collections, galleries, or refined interiors.",

    ku: "تابلۆیەکی ڕەسەن بە شێوازی سکێچی ئاوی کە جەستەی ژنێک پیشان دەدات. ئەم کارە بە ناوی هونەرمەند «Omid» واژوو کراوە و ساڵی 1998 لەسەر نووسراوە."
  },

 dimensions: {
  ar: "الارتفاع: 42 سم — العرض: 28 سم",
  ...
  images: [
    cld("hoa-art-312_pflxx6"),
    cld("hoa-art-312-1_m2efcl")
  ],

  keywords: "لوحة فنية, لوحة جسد أنثوي, لوحة مائية, فنان اوميد, لوحة اصلية, female figure painting, watercolor sketch, omid artist"
},
{
  id: "HOA-ART-313",
  ...
  name: {
    ar: "لوحة بورتريه تجريدي – للفنان سلمان راضي (2003)",
    en: "Abstract Portrait – by Salman Radi (2003)",
    ku: "تابلۆی پرترێتی ئەبسڕاکت – کاری Salman Radi (2003)"
  },

  desc: {
    ar: "لوحة أصلية للفنان سلمان راضي تعود إلى عام 2003، مرسومة بأسلوب تجريدي تعبيري يجمع بين الخطوط السوداء القوية ومساحات لونية جريئة. تتداخل في العمل ألوان الأزرق والأحمر والأصفر والأخضر والبنفسجي لتشكّل بورتريهاً إنسانياً ذا طابع معاصر. تحمل اللوحة توقيع الفنان وتتميز بأسلوب حر يعكس تأثيرات الفن الحديث والتجريد التعبيري، مما يجعلها قطعة فنية مميزة مناسبة للعرض في المساحات الفنية أو ضمن مجموعات التحف الفنية.",

    en: "An original painting by artist Salman Radi dated 2003. The artwork features an expressive abstract portrait style combining bold black outlines with vibrant color fields. Blue, red, yellow, green, and purple tones interact to form a contemporary human portrait composition. Signed by the artist, the piece reflects influences of modern and expressionist art movements, making it a distinctive artwork suitable for galleries or private art collections.",

    ku: "تابلۆیەکی ڕەسەن کاری هونەرمەند Salman Radi لە ساڵی 2003. کارەکە بە شێوازی پرترێتی ئەبسڕاکت دروستکراوە و تێکەڵبوونی ڕەنگە توندەکان و هێڵە ڕەشەکان شێوەیەکی مۆدێرن و هونەری پێدەدات."
  },

  dimensions: {
    ar: "الارتفاع: 45 سم — العرض: 32 سم",
  ...
  images: [
    cld("hoa-art-310-1_wjhpnd"),
    cld("hoa-art-310-2_dqh7zl")
  ],

  keywords: "لوحة, لوحة فنية, سلمان راضي, لوحة تجريدية, بورتريه فني, abstract portrait painting, Salman Radi artwork"
},
{
  id: "HOA-ART-316",
  ...
  name: {
    ar: "لوحة دراسة جسد أنثوي – للفنان أوميد",
    en: "Female Figure Study – by Omid",
    ku: "تابلۆی جەستەی ژن – کاری Omid"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان «أوميد» مرسومة بأسلوب سكتش مائي بسيط يعكس دراسة فنية لجسد أنثوي. تتميز بضربات فرشاة خفيفة وألوان طبيعية هادئة مع خلفية لونية ناعمة، وهو أسلوب قريب من دراسات الرسم الأكاديمية الكلاسيكية. تعد هذه القطعة عملاً فنياً صغير الحجم ومميزاً مناسباً للعرض ضمن مجموعات اللوحات الفنية أو في المساحات الداخلية ذات الطابع الفني.",

    en: "An original artwork signed by the artist “Omid”, created in a delicate watercolor sketch style depicting a female figure study. The painting features soft brush strokes and natural tones with a light background composition, reflecting classical academic figure study techniques. A refined small-scale artwork suitable for art collections or interior display.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەند «Omid» کە بە شێوازی سکێچی ئاوی دروستکراوە و جەستەی ژنێک پیشان دەدات. کارەکە هێڵە ناسک و ڕەنگی ئارام بەکاردەهێنێت و بە شێوازی دروستکردنی جەستە لە هونەری کلاسیکی نزیکە."
  },
  ...
  images: [
    cld("hoa-art-316_awrgar"),
    cld("hoa-art-316-1_jmkjqs")
  ],

  keywords: "لوحة فنية, لوحة جسد أنثوي, لوحة مائية, فنان اوميد, لوحة اصلية, watercolor painting, figure study, Omid artist"
},
{
  id: "HOA-ART-311",
  ...
  name: {
    ar: "لوحة بورتريه تعبيري – للفنان سلمان راضي (2003)",
    en: "Expressionist Portrait – by Salman Radi (2003)",
    ku: "تابلۆی پرترێتی ئەکسپرێسیڤ – کاری Salman Radi (2003)"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان العراقي سلمان راضي تعود إلى عام 2003. العمل ينتمي إلى الأسلوب التعبيري المعاصر حيث تتداخل الخطوط السوداء القوية مع مساحات لونية جريئة من الأحمر والأصفر والأخضر والأزرق. يقدم العمل بورتريهاً إنسانياً ذا طابع درامي يعكس حساً فنياً حراً قريباً من مدارس التعبيرية الحديثة. قطعة فنية مميزة مناسبة للعرض في المجموعات الفنية الخاصة أو في المساحات الثقافية.",

    en: "An original painting signed by Iraqi artist Salman Radi and dated 2003. The artwork follows an expressive contemporary style combining bold black outlines with vibrant color fields including red, yellow, green, and blue. The piece presents a dramatic human portrait reflecting modern expressionist influences. A distinctive artwork suitable for private collections or artistic interiors.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەندی عێراقی Salman Radi لە ساڵی 2003. کارەکە بە شێوازی ئەکسپرێسیڤ دروستکراوە و تێکەڵبوونی ڕەنگە توندەکان و هێڵە ڕەشەکان شێوەیەکی هونەری مۆدێرن پێدەدات."
  },
  ...
  images: [
    cld("hoa-art-311-1_odspfn")
  ],

  keywords: "لوحة فنية, سلمان راضي, لوحة بورتريه, لوحة تعبيرية, لوحة عراقية, Salman Radi painting, expressionist portrait"
},
{
  id: "HOA-ART-314",
  ...
  name: {
    ar: "لوحة  جسد أنثوي – للفنان أوميد",
    en: "Female Figure – by Omid",
    ku: "تابلۆی جەستەی ژن – کاری Omid"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان «أوميد» مرسومة بأسلوب سكتش مائي بسيط يعكس دراسة فنية للجسد الأنثوي. تتميز بألوان دافئة وتدرجات لونية هادئة مع معالجة سريعة بالفرشاة، وهو أسلوب قريب من دراسات الرسم الأكاديمية الكلاسيكية. قطعة فنية صغيرة الحجم مناسبة للعرض ضمن مجموعات اللوحات أو في المساحات الداخلية ذات الطابع الفني.",

    en: "An original artwork signed by the artist “Omid”, created in a delicate watercolor sketch style depicting a female figure study. The piece features warm tones and soft color transitions with expressive brush strokes, reflecting classical academic figure study traditions. A refined small-scale artwork suitable for art collections or interior display.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەند «Omid» کە بە شێوازی سکێچی ئاوی دروستکراوە و جەستەی ژنێک پیشان دەدات. کارەکە ڕەنگی گرم و هێڵی ناسکی هەیە و بە شێوازی دروستکردنی جەستە لە هونەری کلاسیکی نزیکە."
  },

  dimensions: {
    ar: "الارتفاع: 32 سم — العرض: 28 سم",
  ...
  images: [
    cld("hoa-art-313_wdgxrx"),
    cld("hoa-art-313-1_yiiufx")
  ],
...
},
{
  ...
  name: {
    ar: "لوحة امرأة عند النافذة – للفنان أوميد (2001)",
    en: "Woman by the Window – by Omid (2001)",
    ku: "تابلۆی ژن لە بەردەم پەنجەرە – کاری Omid (2001)"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان «أوميد» تعود إلى عام 2001. تقدم العمل مشهداً فنياً لامرأة تقف أمام نافذة داخل فضاء داخلي بسيط، مرسومة بأسلوب تعبيري حر وألوان مائية جريئة تجمع بين الأحمر والأخضر والأصفر. تتداخل الخطوط مع المساحات اللونية لتمنح اللوحة إحساساً بالحركة والحميمية داخل المشهد. قطعة فنية مميزة تعكس حساً معاصراً في معالجة الشكل الإنساني والفضاء الداخلي.",

    en: "An original painting signed by the artist “Omid” and dated 2001. The artwork depicts a woman standing by a window within a simplified interior space, executed in a free expressive watercolor style. Bold tones of red, green, and yellow interact with fluid lines to create a sense of movement and intimacy within the composition. A distinctive piece reflecting a contemporary approach to the human figure and interior space.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەند «Omid» لە ساڵی 2001. کارەکە ژنێک پیشان دەدات کە لە بەردەم پەنجەرەیەکدا وەستاوە لە ناو شوێنێکی ناوخۆیی سادە. شێوازی کارەکە ئەکسپرێسیڤە و بە ڕەنگی ئاوی دروستکراوە کە ڕەنگی سوور و سەوز و زەرد تێکەڵبوون."
  },
  ...
  images: [
    cld("hoa-art-315_xiyzu1"),
    cld("hoa-art-315-1_az8tx0")
  ],

  keywords: "لوحة فنية, لوحة امرأة, لوحة نافذة, لوحة مائية, فنان اوميد, لوحة اصلية, watercolor painting, Omid artist"
},
{
  id: "HOA-ART-317",
  ...
  name: {
    ar: "لوحة امرأة مستلقية – للفنان أوميد (2002)",
    en: "Reclining Woman – by Omid (2002)",
    ku: "تابلۆی ژنی پاڵکەوتوو – کاری Omid (2002)"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان «أوميد» تعود إلى عام 2002. تصور العمل امرأة مستلقية ضمن تكوين لوني جريء يجمع بين الأحمر والأخضر والأصفر مع خلفية معمارية مبسطة. استخدم الفنان أسلوباً تعبيرياً حراً مع ضربات فرشاة مائية واضحة تمنح اللوحة طاقة وحركة داخل المشهد. قطعة فنية مميزة تعكس روح الفن المعاصر وتناسب العرض في المجموعات الفنية الخاصة أو المساحات الداخلية ذات الطابع الثقافي.",

    en: "An original painting signed by the artist “Omid” and dated 2002. The artwork depicts a reclining woman within a bold color composition combining red, green, and yellow tones with a simplified architectural background. Executed in an expressive watercolor style with visible brush strokes, the piece conveys energy and movement within the scene. A distinctive artwork suitable for art collections or refined interiors.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەند «Omid» لە ساڵی 2002. کارەکە ژنێکی پاڵکەوتوو پیشان دەدات لە ناو تێکەڵبوونی ڕەنگە توندەکان و شێوەیەکی مۆدێرن. بە شێوازی ئەکسپرێسیڤ و ڕەنگی ئاوی دروستکراوە."
  },
  ...
  images: [
    cld("hoa-art-314_brhjxf"),
    cld("hoa-art-314-1_gf0ntd")
  ],

  keywords: "لوحة فنية, لوحة امرأة, لوحة تعبيرية, لوحة مائية, فنان اوميد, لوحة اصلية, watercolor painting, Omid artist"
},
{
  id: "HOA-ART-318",
  ...
  name: {
    ar: "لوحة جسد أنثوي – للفنان أوميد",
    en: "Female Figure Painting – by Omid",
    ku: "تابلۆی جەستەی ژن – کاری Omid"
  },

  desc: {
    ar: "لوحة أصلية موقعة من الفنان «أوميد» مرسومة بأسلوب تعبيري بسيط باستخدام الألوان المائية. يظهر في العمل جسد أنثوي ضمن تكوين لوني دافئ بدرجات الأحمر والوردي مع معالجة حرة بالفرشاة. تعكس اللوحة حساً فنياً مباشراً وبسيطاً يميز أعمال الفنان في معالجة الشكل الإنساني بأسلوب معاصر.",

    en: "An original painting signed by the artist “Omid”, executed in an expressive watercolor style. The artwork depicts a female figure rendered with warm tones of red and pink, using loose brushwork that gives the composition a spontaneous artistic character. A refined piece reflecting a contemporary approach to the human form.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی هونەرمەند «Omid» کە بە شێوازی ڕەنگی ئاوی دروستکراوە و جەستەی ژنێک پیشان دەدات. ڕەنگە گرمەکان و هێڵی ناسک شێوەیەکی هونەری سادە و مۆدێرن پێدەدەن."
  },
  ...
  images: [
    cld("hoa-art-317_sbd3lb")
  ],

  keywords: "لوحة فنية, لوحة جسد أنثوي, لوحة مائية, فنان اوميد, لوحة اصلية, watercolor painting, omid artist"
},
{
  id: "HOA-ART-318",
  ...
  name: {
    ar: "دراسة جسد أنثوي – أوميد",
    en: "Female Figure Study – Omid",
    ku: "خوێندنی جەستەی ژن – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1999، مرسومة بالألوان المائية بأسلوب سريع وحيوي يركز على دراسة الجسد الإنساني. يظهر العمل معالجة لونية بسيطة وخلفية خفيفة تعطي حضوراً واضحاً للشكل الإنساني.",

    en: "An original signed artwork by Omid from 1999, executed in watercolor. The painting represents a figurative study of the human body with expressive brushwork and a soft background that emphasizes the form.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1999 کە بە ڕەنگی ئاوی دروستکراوە و خوێندنەوەیەکی هونەری بۆ جەستەی مرۆڤ پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-318_1_fqf3ca"),
    cld("hoa-art-318_2_y2dkby")
  ],

  keywords: "لوحة فنية, لوحة جسد, اوميد, لوحة مائية, فن معاصر, omid painting, watercolor figure"
},
{
  id: "HOA-ART-319",
  ...
  name: {
    ar: "دراسة جسد أنثوي جالسة – أوميد",
    en: "Seated Female Figure Study – Omid",
    ku: "خوێندنی جەستەی ژنی دانیشتوو – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالألوان المائية بأسلوب سريع وتعبيري. يظهر في العمل جسد أنثوي جالس مع معالجة لونية حرة وخلفية بسيطة، وهو أسلوب يميز أعمال الفنان في دراسات الجسد.",

    en: "An original signed watercolor artwork by Omid dated 1998. The painting depicts a seated female figure executed with expressive brushwork and loose color treatment, characteristic of the artist’s figurative studies.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە ڕەنگی ئاوی دروستکراوە و جەستەی ژنێکی دانیشتوو پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-319_py5bfa"),
    cld("hoa-art-319-1_vdp5fq")
  ],

  keywords: "لوحة فنية, لوحة جسد, اوميد, لوحة مائية, دراسة فنية, omid painting, watercolor figure"
},
{
  id: "HOA-ART-320",
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالألوان المائية بأسلوب تعبيري سريع. يظهر في العمل جسد أنثوي جالس مع معالجة لونية حرة بدرجات الأحمر، وهو أسلوب يميز دراسات الفنان للجسد الإنساني.",

    en: "An original signed watercolor artwork by Omid from 1998. The painting depicts a seated female figure rendered with expressive brushwork and warm red tones, characteristic of the artist’s figurative studies.",
  ...
  images: [
    cld("hoa-art-320_p5ramh"),
    cld("hoa-art-321-1_acexvd")
  ],
...
},
{
  ...
  name: {
    ar: "دراسة جسد أنثوي مستلقية – أوميد",
    en: "Reclining Female Figure Study – Omid",
    ku: "خوێندنی جەستەی ژنی خەوتوو – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، مرسومة بالألوان المائية بأسلوب سريع وتعبيري. يظهر في العمل جسد أنثوي في وضعية استلقاء مع معالجة لونية حرة وخلفية بسيطة بدرجات الأزرق والأحمر.",

    en: "An original signed watercolor artwork by Omid dated 1998. The painting depicts a reclining female figure rendered with expressive brushwork and loose color treatment with blue and warm tones.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە ڕەنگی ئاوی دروستکراوە و جەستەی ژنێکی خەوتوو پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-322_ewfsqt"),
    cld("hoa-art-322-1_miihwt")
  ],
...
},
{
  ...
  name: {
    ar: "لوحة جسد أنثوي مع مزهرية – أوميد",
    en: "Female Figure with Vase – Omid",
    ku: "تابلۆی ژن لەگەڵ گڵدان – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، مرسومة بالألوان المائية بأسلوب تعبيري حر. يظهر في العمل جسد أنثوي إلى جانب مزهرية تحتوي على أزهار ملونة، مع معالجة لونية ناعمة بدرجات الوردي والأصفر.",

    en: "An original signed watercolor painting by Omid dated 1998. The artwork depicts a female figure seated beside a vase of flowers, rendered with expressive brushwork and soft tones of pink and yellow.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە ژنێک لەگەڵ گڵدانێک پیشان دەدات و بە ڕەنگی ئاوی بە شێوەیەکی هونەری دروستکراوە."
  },
  ...
  images: [
    cld("hoa-art-323_arlf7n")
  ],

  keywords: "لوحة فنية, اوميد, لوحة جسد, لوحة مائية, لوحة مع مزهرية, omid painting, watercolor figure"
},
{
  id: "HOA-ART-324",
  ...
  name: {
    ar: "لوحة تكوين جسدي بالحبال – أوميد",
    en: "Bound Figures Composition – Omid",
    ku: "تابلۆی پێکهاتەی جەستە بە حەبل – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، مرسومة بالحبر والألوان المائية. يظهر في العمل تكوين درامي لعدة أجساد بشرية متشابكة بالحبال في معالجة تعبيرية قوية تعكس حركة الجسد والتوتر في التكوين.",

    en: "An original signed artwork by Omid dated 1998, executed in ink and watercolor. The composition depicts intertwined human figures bound with ropes, rendered in an expressive style emphasizing movement and dramatic tension.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و پێکهاتەیەکی جەستەی مرۆڤ پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-324_zmjyil")
  ],

  keywords: "لوحة فنية, اوميد, لوحة جسد, لوحة حبر, لوحة مائية, تكوين جسدي, omid painting"
},
{
  id: "HOA-ART-325",
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية بأسلوب تعبيري حر. يظهر في العمل جسد أنثوي في تكوين داخلي مع عناصر طبيعية مثل المزهرية والزهور، مما يمنح اللوحة طابعاً حميمياً وحركة لونية غنية.",

    en: "An original signed artwork by Omid dated 1998, executed in ink and watercolor. The composition depicts a female figure in an interior scene beside a vase of flowers, rendered with expressive lines and soft color washes.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و ژنێک لە ناوەوەی ژوورێک لەگەڵ گڵدان پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-325_mpi8de"),
    cld("hoa-art-325-1_edlkkw")
  ],

  keywords: "لوحة فنية, اوميد, لوحة جسد, لوحة مائية, لوحة حبر, omid painting, figurative art"
},
{
  id: "HOA-ART-326",
  ...
  name: {
    ar: "لوحة تكوين نسوي داخلي – أوميد",
    en: "Interior Female Composition – Omid",
    ku: "تابلۆی ژنان لە ناو ژوور – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية. يظهر في العمل تكوين لامرأتين داخل فضاء داخلي مع عناصر مثل المرآة والشمعة، بأسلوب خطي تعبيري يميز أعمال الفنان.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts two female figures within an interior setting with elements such as a mirror and candle, rendered in expressive linework.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و دوو ژن لە ناو ژوورێک پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-326_jmoonz")
  ],

  keywords: "لوحة فنية, اوميد, لوحة نساء, لوحة حبر, لوحة مائية, omid painting, figurative art"
},
{
  id: "HOA-ART-327",
  ...
  name: {
    ar: "لوحة تكوين نسوي في مشهد حضري – أوميد",
    en: "Urban Female Composition – Omid",
    ku: "تابلۆی ژنان لە دیمەنی شار – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية. يظهر في العمل تكوين تعبيري لامرأتين ضمن فضاء حضري، مع معالجة خطية واضحة وألوان مائية خفيفة تعطي اللوحة طابعاً درامياً.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts female figures in an urban setting with expressive linework and soft watercolor washes.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و ژنان لە دیمەنێکی شار پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-327_vaxhab")
  ],

  keywords: "لوحة فنية, اوميد, لوحة نساء, لوحة حبر, لوحة مائية, figurative art, omid painting"
},
{
  id: "HOA-ART-328",
  ...
  name: {
    ar: "لوحة جسد أنثوي مع آلة موسيقية – أوميد",
    en: "Female Figure with Musical Instrument – Omid",
    ku: "تابلۆی ژن لەگەڵ ئامێری موزیک – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية. يظهر في العمل جسد أنثوي يعزف على آلة موسيقية في تكوين تعبيري مفعم بالحركة والإيقاع.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts a female figure playing a musical instrument in an expressive and dynamic style.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و ژنێک لەگەڵ ئامێرێکی موزیک پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-328_nmpnc7")
  ],

  keywords: "لوحة فنية, اوميد, لوحة نساء, لوحة موسيقى, لوحة حبر, لوحة مائية, omid painting"
},
{
  id: "HOA-ART-329",
  ...
  name: {
    ar: "لوحة جسد أنثوي مستلقية – أوميد",
    en: "Reclining Female Figure – Omid",
    ku: "تابلۆی ژنی خەوتوو – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية بأسلوب تعبيري حر. يظهر في العمل جسد أنثوي مستلقٍ ضمن تكوين بسيط وألوان ناعمة تمنح اللوحة إحساساً هادئاً.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts a reclining female figure rendered with expressive linework and soft watercolor tones.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و ژنێکی خەوتوو پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-329_ts1iar")
  ],

  keywords: "لوحة فنية, اوميد, لوحة نساء, لوحة جسد, لوحة حبر, لوحة مائية, omid painting"
},
{
  id: "HOA-ART-330",
  ...
  name: {
    ar: "لوحة شخصين مستلقيين – أوميد",
    en: "Two Reclining Figures – Omid",
    ku: "تابلۆی دوو کەس خەوتوو – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية. يظهر في العمل تكوين تعبيري لشخصين مستلقيين في مشهد حميمي بسيط مع عناصر يومية مرسومة بخطوط حرة.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts two reclining figures in an intimate expressive scene with loose dynamic linework.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و دوو کەسی خەوتوو پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-330_q4lhst")
  ],

  keywords: "لوحة فنية, اوميد, لوحة تعبيرية, لوحة نساء, لوحة حبر, لوحة مائية, omid painting"
},
{
  id: "HOA-ART-331",
  ...
  name: {
    ar: "لوحة جسد أنثوي جالس – أوميد",
    en: "Seated Female Nude – Omid",
    ku: "تابلۆی ژنی دانیشتوو – Omid"
  },
  ...
  desc: {
    ar: "لوحة أصلية موقعة للفنان أوميد تعود إلى عام 1998، منفذة بالحبر والألوان المائية بأسلوب تعبيري ناعم يبرز حركة الجسد واللون بشكل حر.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The piece depicts a seated female nude rendered with expressive linework and fluid watercolor tones.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە و ژنێکی دانیشتوو پیشان دەدات."
  },
  ...
  images: [
    cld("hoa-art-331_pet30b")
  ],

  keywords: "لوحة فنية, اوميد, لوحة جسد, لوحة نساء, لوحة حبر, لوحة مائية, omid painting"
},
{
  id: "HOA-ART-332",
  ...
  name: {
    ar: "امرأة على ضوء الحرير – أوميد",
    en: "Woman in Silk Light – Omid",
    ku: "ژن لە ڕووناکی هەریر – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري أنيق. تظهر في اللوحة امرأة تجلس على قماش حريري ذهبي، في تكوين هادئ تتداخل فيه الألوان الناعمة مع حركة الجسد بخفة شاعرية. هذه القطعة تمثل مثالاً جميلاً على أعمال أوميد في دراسة الجسد الإنساني بأسلوب حر ومباشر، ما يجعلها عملاً مناسباً للعرض في المساحات الفنية أو المجموعات الخاصة.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition presents a seated female figure resting on flowing golden fabric, rendered with soft expressive brushwork. The elegant balance between line and watercolor makes this piece a refined example of Omid's figurative studies and a distinctive addition to any curated art collection.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. ژنێک لەسەر پارچەیەکی زێڕینی نەرم دانیشتووە و بە شێوەیەکی هێمن و هونەری پیشان دراوە."
  },
  ...
  images: [
    cld("hoa-art-332_fgclzs")
  ],

  keywords: "لوحة فنية, اوميد, لوحة نساء, لوحة تعبيرية, لوحة حبر, لوحة مائية, omid painting"
},
{
  id: "HOA-ART-334",
  ...
  name: {
    ar: "امرأتان في ضوء الحديقة – أوميد",
    en: "Two Women in Garden Light – Omid",
    ku: "دوو ژن لە ڕووناکی باخچە – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري حر. تُظهر اللوحة تكويناً إنسانياً لامرأتين في فضاء مفتوح تحيط به الطبيعة، حيث تتداخل الخطوط السريعة مع الخلفية اللونية الهادئة. يمنح التكوين إحساساً بالاسترخاء والحرية، بينما تضيف التفاصيل البسيطة مثل الطاولة والزجاجة بعداً يومياً حميماً للمشهد. يمثل هذا العمل مثالاً جميلاً على أسلوب أوميد في الجمع بين الرسم الخطي الحر ولمسات الألوان المائية.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts two female figures placed within a relaxed outdoor setting surrounded by natural elements. Expressive line work combined with soft watercolor washes creates a poetic atmosphere typical of Omid's figurative studies, making the piece a refined addition to a curated art collection.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا دوو ژن لە ناو دیمەنێکی سروشتی و هێمن پیشان دراون و هێڵە هونەرییەکان لەگەڵ ڕەنگە نەرمەکان دیمەنێکی شاعیرانە دروست دەکەن."
  },
...
},
{
  ...
  name: {
    ar: "امرأة بثوب أزرق – أوميد",
    en: "Woman in Blue Drapery – Omid",
    ku: "ژن لە جلێکی شین – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري رقيق. تُظهر اللوحة امرأة جالسة ينسدل حولها قماش أزرق واسع، بينما تُرسم تفاصيل الجسد بخطوط خفيفة وحرة تمنح التكوين إحساساً بالهدوء والنعومة. يجمع العمل بين شفافية الألوان المائية وبساطة الخطوط، وهو من الأمثلة المميزة على دراسات الجسد التي اشتهر بها أوميد.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts a seated female figure partially draped in flowing blue fabric, rendered with delicate expressive lines and soft watercolor washes. The balance between minimal line work and atmospheric color makes this piece a refined example of Omid’s figurative studies.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. ژنێک دانیشتووە و پارچەیەکی شین بە شێوەیەکی نەرم لە دەوری دا کەوتووە، کە هێڵە هونەرییەکان و ڕەنگە نەرمەکان دیمەنێکی هێمن و جوان دروست دەکەن."
  },
...
},
{
  ...
  name: {
    ar: "امرأة مع الجرار – أوميد",
    en: "Woman with Clay Jars – Omid",
    ku: "ژن لەگەڵ کوزەکان – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري حر. تُظهر اللوحة امرأة تقف في تكوين بسيط تحيط به جرار فخارية وأقمشة ملونة، حيث تتداخل الخطوط الحرة مع مساحات الألوان المائية الدافئة. يعكس العمل أسلوب أوميد في دراسة الجسد الإنساني بطريقة مباشرة وبسيطة، مع إضافة عناصر طبيعية تضفي على المشهد طابعاً هادئاً وحميمياً.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition features a standing female figure surrounded by clay jars and soft draped fabrics. Expressive line work combined with warm watercolor tones creates a relaxed and intimate atmosphere characteristic of Omid’s figurative studies.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. ژنێک لە ناو دیمەنێکی سادەدا ڕاوەستاوە و لە دەوری کوزە و پارچەی ڕەنگاوڕەنگ هەیە، کە هێڵە هونەرییەکان لەگەڵ ڕەنگە نەرمەکان دیمەنێکی هێمن دروست دەکەن."
  },
...

{
  ...
  name: {
    ar: "ثنائيات الجسد – أوميد",
    en: "Dual Figures – Omid",
    ku: "دوو لاشی مرۆڤ – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري حر. تُظهر اللوحة تكويناً إنسانياً لامرأتين في وضعية هادئة تنعكس فيها دراسة الجسد بخطوط سريعة وانسيابية، بينما تضيف الألوان المائية خلفية شاعرية ناعمة. يجمع العمل بين قوة الخط وشفافية اللون، وهو من النماذج المميزة لأعمال أوميد التي تركز على الجسد الإنساني والتكوينات التعبيرية.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition presents two female figures rendered with expressive flowing lines and delicate washes of color. The balance between sketch-like line work and soft watercolor atmosphere reflects Omid’s distinctive figurative style, making it a compelling addition to any curated art collection.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا دوو ژن بە شێوەیەکی هونەری و هێمن پیشان دراون، کە هێڵە خێراکان و ڕەنگە نەرمەکان ڕەنگدانەوەیەکی تایبەتیان دروست کردووە."
  },
...
},
{
  ...
  name: {
    ar: "امرأة متصابية – أوميد",
    en: "Playful Woman – Omid",
    ku: "ژنێکی گەنجانە – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1998، منفذ بالحبر والألوان المائية بأسلوب تعبيري حر. تظهر في اللوحة امرأة مستلقية في وضعية مرحة وعفوية تحيط بها عناصر من الأواني والزجاجيات، بينما تتداخل الخطوط الحرة مع بقع الألوان المائية الهادئة. على ظهر اللوحة كتب الفنان بخط يده عبارة «امرأة متصابية»، ما يمنح العمل بعداً شخصياً إضافياً ويعكس روح التكوين الحيوية.",

    en: "An original signed artwork by Omid dated 1998 executed in ink and watercolor. The composition depicts a reclining female figure surrounded by decorative vessels rendered with expressive line work and soft washes of color. On the reverse side, the artist handwrittenly titled the piece 'Playful Woman', adding a personal narrative layer to the artwork.",

    ku: "تابلۆیەکی ڕەسەن واژووکراوی Omid لە ساڵی 1998 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. لە پشتەوەی تابلۆکەدا هونەرمەند بە دەستی خۆی ناوی «امرأة متصابية» نووسیویە، کە مانایەکی کەسی و هونەری زیاتر بە کارەکە دەدات."
  },
  ...
  images: [
    cld("hoa-art-337_o3tioa"),
    cld("hoa-art-337-1_rnx8kh")
  ],
...
},
{
  ...
  name: {
    ar: "اندفاع الخيول – أوميد",
    en: "Charging Horses – Omid",
    ku: "ئەسپەکان لە هێرشدا – Omid"
  },
  ...
  dimensions: {
    ar: "الارتفاع: 32 سم — العرض: 38 سم",
    en: "Height: 32 cm — Width: 38 cm",
    ku: "بەرزی: 32 سم — پانی: 38 سم"
  },

  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1999، منفذ بالألوان المائية بأسلوب تعبيري نابض بالحركة. تظهر في اللوحة خيول في لحظة اندفاع قوية، حيث تتداخل ضربات اللون الداكن مع الأحمر والأبيض لتشكل إحساساً بالطاقة والسرعة. يعتمد الفنان على اختزال التفاصيل والتركيز على الحركة، ما يمنح التكوين قوة بصرية واضحة ويجعل العمل قطعة لافتة للنظر داخل أي مجموعة فنية.",

    en: "An original signed watercolor by Omid dated 1999. The painting captures a powerful moment of two horses in motion, rendered through expressive brushwork and bold contrasts of dark, red, and white tones. The artist simplifies details to emphasize energy and movement, creating a striking composition that conveys strength and vitality.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Omid لە ساڵی 1999 کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا دوو ئەسپ لە کاتی هێرش و جوڵەی توند پیشان دراون، کە هێڵە هونەرییەکان و ڕەنگە بەهێزەکان هەستێکی وزە و خێرایی دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art-338_qkss1c"),
    cld("hoa-art-338-1_ee81hn")
  ],

  keywords: "لوحة خيول, لوحة فنية, اوميد, لوحة تعبيرية, watercolor horse painting, omid painting"
},
{
  id: "HOA-ART-339",
  ...
  name: {
    ar: "شناشيل بغداد – أوميد",
    en: "Baghdad Shanasheel – Omid",
    ku: "شناشێلی بەغدا – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1999، منفذ بالألوان المائية بأسلوب انطباعي سريع. تصور اللوحة واجهة بيت بغدادي تقليدي بزخارف الشناشيل الخشبية، حيث تتداخل الظلال البنفسجية والرمادية مع الضوء الدافئ لتمنح المشهد إحساساً بالحياة اليومية في الأزقة القديمة. يعتمد الفنان على ضربات فرشاة حرة تختزل التفاصيل المعمارية وتبرز روح المكان، ما يجعل العمل قطعة شاعرية تعكس ذاكرة بغداد العمرانية.",

    en: "An original watercolor painting by Omid dated 1999. The composition captures a traditional Baghdadi house with its iconic wooden shanasheel balconies. Soft purples and warm earthy tones create an atmospheric impression of an old alleyway scene. With loose brushwork and simplified architectural forms, the painting conveys the nostalgic character of Baghdad’s historic streets.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Omid لە ساڵی 1999 کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا ماڵێکی بەغدادی بە شناشێلی دارین پیشان دراوە، کە ڕەنگە نەرم و هێڵە خێراکان هەستێکی یادەوەریی و کۆنەشاری دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art-339_ie0gak"),
    cld("hoa-art-339-1_ehjx43")
  ],

  keywords: "لوحة بغداد, شناشيل بغداد, لوحة معمارية, اوميد, watercolor city painting, baghdad architecture painting"
},
{
  id: "HOA-ART-340",
  ...
  name: {
    ar: "أزقة الشناشيل – أوميد",
    en: "Shanasheel Alley – Omid",
    ku: "کۆچەی شناشێل – Omid"
  },
  ...
  desc: {
    ar: "عمل فني أصلي موقّع للفنان أوميد يعود إلى عام 1999، منفذ بالألوان المائية بأسلوب انطباعي سريع. تُظهر اللوحة بيتاً بغدادياً تقليدياً بشناشيله الخشبية المطلة على زقاق قديم، حيث تتداخل الظلال البنفسجية والرمادية مع الضوء الدافئ لتعكس أجواء الحياة اليومية في بغداد القديمة. يعتمد الفنان على ضربات فرشاة خفيفة تختزل التفاصيل المعمارية وتبرز روح المكان، ما يمنح العمل إحساساً بالحنين وذاكرة المدينة.",

    en: "An original watercolor painting by Omid dated 1999. The artwork depicts a traditional Baghdadi house with its distinctive wooden shanasheel balconies overlooking a quiet alley. Soft purples, warm earth tones, and loose brushwork create an atmospheric impression of old Baghdad, capturing both architectural character and everyday life.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Omid لە ساڵی 1999 کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا ماڵێکی بەغدادی بە شناشێلی دارین پیشان دراوە کە سەر زەقاقێکی کۆن دەڕوانێت، و ڕەنگە نەرمەکان هەستێکی یادەوەریی شارە کۆنەکان دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art-340_ssg8re"),
    cld("hoa-art-340-1_humxcl")
  ],

  keywords: "لوحة بغداد, شناشيل بغداد, لوحة معمارية, اوميد, watercolor baghdad, baghdad architecture painting"
},
{
  id: "HOA-ART-341",
  ...
  name: {
    ar: "فتاة عند ضفة الماء – سعد",
    en: "Girl by the Water – Saad",
    ku: "کچەکە لە کەناری ئاو – Saad"
  },
  ...
  dimensions: {
    ar: "الارتفاع: 50 سم — العرض: 35 سم",
    en: "Height: 50 cm — Width: 35 cm",
    ku: "بەرزی: 50 سم — پانی: 35 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان سعد يعود إلى عام 2016، منفذ بالألوان المائية بأسلوب هادئ وانسيابي. تُظهر اللوحة فتاة تقف عند ضفة ماء في لحظة تأمل، حيث تنسدل الأقمشة الخفيفة حول الجسد بينما تنعكس ألوان الأرض والسماء في الخلفية. تعتمد اللوحة على ضربات مائية شفافة وتدرجات دافئة تمنح التكوين إحساساً بالهدوء والسكينة، ما يجعلها قطعة شاعرية مناسبة للمجموعات الفنية المعاصرة.",

    en: "An original watercolor painting by Saad dated 2016. The composition portrays a young woman standing by the water in a quiet reflective moment. Soft flowing brushstrokes and warm earthy tones create a calm atmosphere, while the simplicity of the figure and landscape gives the work a poetic and contemporary character.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Saad لە ساڵی 2016 کە بە ڕەنگی ئاوی دروستکراوە. کچێک لە کەناری ئاو وەستاوە و لە کاتێکی هێمن و بیرکردنەوەدا پیشان دراوە، و ڕەنگە نەرمەکان هەستێکی ئارامی دروست دەکەن."
  },

  images: [
    cld("hoa-art-341_b7qk5i")
  ],

  keywords: "لوحة فنية, سعد, لوحة مائية, watercolor figure painting, saad artist"
},
{
  id: "HOA-ART-342",
  ...
  name: {
    ar: "الفتاة والحصان – سعد",
    en: "The Girl and the Horse – Saad",
    ku: "کچ و ئەسپ – Saad"
  },
  ...
  dimensions: {
    ar: "الارتفاع: 30 سم — العرض: 20 سم",
    en: "Height: 30 cm — Width: 20 cm",
    ku: "بەرزی: 30 سم — پانی: 20 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان سعد منفذ بالألوان المائية بأسلوب تعبيري حر. تُظهر اللوحة فتاة تجلس بهدوء مقابل حصان في لحظة تواصل صامت بين الإنسان والطبيعة. تتداخل ضربات الفرشاة السريعة مع تدرجات لونية شفافة تمنح العمل إحساساً بالحركة والهدوء في آن واحد. يركز الفنان على التعبير الإنساني البسيط وعلى العلاقة الرمزية بين الإنسان والحيوان في تكوين بصري شاعر.",

    en: "An original watercolor painting by Saad executed in a loose expressive style. The composition presents a quiet moment between a seated young woman and a horse, suggesting a subtle connection between human and nature. Transparent washes and fluid brushwork create an atmospheric and poetic visual balance.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Saad کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا کچێک لەگەڵ ئەسپێک لە کاتێکی هێمن پیشان دراون، کە پەیوەندییەکی هێمن لە نێوان مرۆڤ و سروشت نیشان دەدات."
  },

  images: [
    cld("hoa-art-342_y5tpvz")
  ],

  keywords: "لوحة فنية, سعد, فتاة وحصان, watercolor figure painting, saad artist"
},
{
  id: "HOA-ART-343",
  ...
  name: {
    ar: "ضوء في الزقاق – سعد",
    en: "Light in the Alley – Saad",
    ku: "ڕووناکی لە کۆچەدا – Saad"
  },
  ...
  dimensions: {
    ar: "الارتفاع: 35 سم — العرض: 25 سم",
    en: "Height: 35 cm — Width: 25 cm",
    ku: "بەرزی: 35 سم — پانی: 25 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان سعد يعود إلى عام 2008، منفذ بالألوان المائية بأسلوب انطباعي هادئ. تُظهر اللوحة مجموعة من الأشخاص يسيرون داخل زقاق مضاء بضوء الشمس، حيث تتشكل بقعة الضوء في مركز التكوين بينما تذوب الأشكال في الظلال المحيطة. يعتمد الفنان على تباين الضوء والظل ليخلق عمقاً بصرياً وشعوراً بالحركة اليومية داخل المدينة.",

    en: "An original watercolor painting by Saad dated 2008. The composition depicts several figures walking through a narrow alley illuminated by a beam of sunlight. The contrast between light and shadow creates depth and movement, giving the scene a quiet yet dynamic urban atmosphere.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Saad لە ساڵی 2008 کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا خەڵک لە کۆچەیەکدا دەڕۆن کە ڕووناکی خۆر بە ناوەڕاستی دیمەنەکەدا دەکەوێت و هێڵ و ڕەنگەکان هەستێکی جوڵە و ژیانی ڕۆژانە دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art-343_fjv3yx")
  ],

  keywords: "لوحة فنية, سعد, لوحة مدينة, watercolor street scene, saad painting"
},
{
  id: "HOA-ART-344",
  ...
  dimensions: {
    ar: "الارتفاع: 34 سم — العرض: 25 سم",
    en: "Height: 34 cm — Width: 25 cm",
    ku: "بەرزی: 34 سم — پانی: 25 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان سعد يعود إلى عام 2012 منفذ بالألوان المائية بأسلوب انطباعي حر. تصور اللوحة مشهداً من سوق شعبي حيث تتداخل حركة الباعة والمتسوقين مع الألوان الدافئة للفواكه والخضار. يستخدم الفنان ضربات فرشاة سريعة وتدرجات لونية شفافة ليخلق إحساساً بالحياة اليومية والضوء داخل السوق، ما يمنح التكوين طابعاً نابضاً بالحركة والواقعية.",

    en: "An original watercolor painting by Saad dated 2012. The artwork depicts a lively market scene where vendors, shoppers, and colorful produce create a vibrant everyday atmosphere. Loose brushwork and transparent watercolor layers capture the movement and light of the marketplace, giving the composition a dynamic urban character.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Saad لە ساڵی 2012 کە بە ڕەنگی ئاوی دروستکراوە. لە تابلۆکەدا دیمەنێکی بازاڕی ڕۆژانە پیشان دراوە کە جوڵەی خەڵک و ڕەنگی میوە و سەوزەکان هەستێکی ژیانی ڕۆژانە دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art-344_xi6sig"),
    cld("hoa-art-344-1_s2ncvb"),
    cld("hoa-art-344-2_unnfr4")
  ],

  keywords: "لوحة سوق, لوحة مدينة, لوحة فنية, سعد, watercolor market scene, saad painting"
},
{
  id: "HOA-ART-345",
  ...
  name: {
    ar: "مشهد من السوق القديم – حسين العزاوي",
    en: "Scene from the Old Market – Hussein Al-Azzawi",
    ku: "دیمەنی بازاڕی کۆن – Hussein Al-Azzawi"
  },

  artist: "Hussein Al-Azzawi",
  year: "1999",

  dimensions: {
    ar: "الارتفاع: 33 سم — العرض: 30 سم",
    en: "Height: 33 cm — Width: 30 cm",
    ku: "بەرزی: 33 سم — پانی: 30 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان حسين العزاوي يعود إلى عام 1999، منفذ بالحبر والألوان المائية بأسلوب يجمع بين الرسم السريع والتلوين الشفاف. تصور اللوحة مشهداً من الحياة اليومية في أحد الأسواق الشعبية حيث يجتمع الباعة والمتسوقون في زقاق قديم تحيط به البيوت التقليدية. يستخدم الفنان خطوطاً حرة وتدرجات لونية هادئة ليعكس حركة الناس ودفء الحياة الاجتماعية في المدينة.",

    en: "An original artwork by Hussein Al-Azzawi dated 1999 executed in ink and watercolor. The painting captures a lively scene from an old neighborhood market where vendors and passersby gather in a narrow street surrounded by traditional architecture. Loose lines and transparent washes create a sense of everyday life and human interaction within the urban environment.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Hussein Al-Azzawi لە ساڵی 1999 کە بە حەبر و ڕەنگی ئاوی دروستکراوە. دیمەنێک لە ژیانی ڕۆژانەی بازاڕێکی کۆن پیشان دەدات کە خەڵک و فرۆشیاران لە کۆچەیەکی تنگدا کۆدەبنەوە."
  },
  ...
  images: [
    cld("hoa-art-345_bhtaxt"),
    cld("hoa-art-345-1_ywe9x9"),
    cld("hoa-art-345-2_abdlll")
  ],

  keywords: "لوحة سوق قديم, حسين العزاوي, لوحة مدينة, watercolor market scene, Iraqi art painting"
},
{
  id: "HOA-ART-346",
  ...
  name: {
    ar: "بوابة من دمشق – سعيد سليم",
    en: "Gate of Damascus – Saeed Salim",
    ku: "دەروازەی دەمەشق – Saeed Salim"
  },
  ...
  dimensions: {
    ar: "الارتفاع: 40 سم — العرض: 30 سم",
    en: "Height: 40 cm — Width: 30 cm",
    ku: "بەرزی: 40 سم — پانی: 30 سم"
  },

  desc: {
    ar: "عمل فني أصلي للفنان سعيد سليم يعود إلى عام 2007 منفذ بالحبر بأسلوب دقيق يعتمد على الخطوط التفصيلية. تصور اللوحة بوابة معمارية من الطراز التاريخي في أحد أحياء سوريا القديمة، حيث تظهر الجدران الحجرية والأقواس والناس في مشهد يومي نابض بالحياة. يركز الفنان على إبراز التفاصيل المعمارية والملمس الحجري للبناء، ما يمنح العمل طابعاً توثيقياً يجمع بين الفن والذاكرة التاريخية.",

    en: "An original ink drawing by Saeed Salim dated 2007. The artwork depicts a historic architectural gate within an old Syrian neighborhood. Through precise line work and detailed textures, the artist captures the stone structures, arches, and everyday life surrounding the gate. The piece combines documentary precision with artistic expression, reflecting the heritage of traditional Middle Eastern architecture.",

    ku: "تابلۆیەکی ڕەسەن لە هونەرمەندی Saeed Salim لە ساڵی 2007 کە بە حەبر دروستکراوە. دەروازەیەکی مێژوویی لە ناو شارێکی کۆنی سوریا پیشان دەدات کە هێڵە وردەکان و وردەکارییەکان هەستێکی مێژوویی و شارستانی دروست دەکەن."
  },
  ...
  images: [
    cld("hoa-art346_wxshmu"),
    cld("hoa-art-346-1_o7tuxg"),
    cld("hoa-art-346-2_uss5gn"),
    cld("hoa-art-346-3_py8rzo")
  ],

  keywords: "لوحة معمارية, دمشق, سوريا, سعيد سليم, رسم حبر, ink architectural drawing, middle eastern architecture"
},
{
  id: "HOA-ART-347",
  ...
  name: {
    ar: "أشلاء من العراق – سعد",
    en: "Fragments of Iraq – Saad",
    ku: "پارچەکان لە عێراق – Saad"
  },
  ...
  desc: {
    ar: "عمل فني تعبيري للفنان سعد يعود إلى عام 2008 بعنوان «أشلاء من العراق». تستخدم اللوحة ضربات مائية حادة وتكويناً بصرياً كثيفاً يعكس حالة من التوتر والذاكرة المؤلمة. يظهر وجه إنساني غارق في الظلال وسط مساحات لونية متكسرة، في إشارة رمزية إلى مرحلة عصيبة من تاريخ العراق. العمل يحمل طابعاً عاطفياً قوياً ويعبر عن الألم والذاكرة والإنسان وسط الفوضى.",

    en: "An expressive watercolor artwork by Saad dated 2008 titled 'Fragments of Iraq'. The composition uses bold brush strokes and fragmented color fields to convey tension and emotional depth. A human face emerges from shadows within chaotic layers of paint, symbolizing the struggles and memories of a difficult period in Iraq's history. The piece carries strong emotional intensity and narrative symbolism.",

    ku: "تابلۆیەکی دەربڕینی بە هۆنەرمەندی Saad لە ساڵی 2008 بە ناونیشانی «Fragments of Iraq». هێڵ و ڕەنگەکان بە شێوەیەکی توند بەکار هاتوون بۆ پیشاندانی هەستی ئاڵۆزی و بیرەوەرییەکان."
  },
  ...
  images: [
    cld("hoa-art-347_sk49cu"),
    cld("hoa-art-347-1_vytrs4")
  ],

  keywords: "لوحة تعبيرية, الفن العراقي المعاصر, Saad artist, expressionist painting, Iraqi contemporary art"
},
{
  id: "HOA-ART-348",
  category: {
  ...
  name: {
    ar: "جسد متشظٍ – طالب جبار",
    en: "Fragmented Body – Talib Jabbar",
    ku: "لەشێکی پارچەپارچە – Talib Jabbar"
  },
  ...
  desc: {
    ar: "عمل فني أصلي للفنان طالب جبار، منفذ بالحبر الأسود بأسلوب تعبيري حاد يعتمد على الخطوط الكثيفة والتكوين العمودي الضاغط. تظهر في اللوحة هيئة أنثوية متداخلة مع عناصر عضوية وخشبية في بناء بصري متشظٍ، ما يمنح العمل طاقة نفسية قوية وإحساساً بالتوتر والانكشاف. التكوين الجريء والخط المنفلت يضعان هذه القطعة ضمن الأعمال التي تفرض حضورها بصرياً، وتناسب المجموعات الفنية الجادة والمساحات التي تبحث عن عمل يحمل شخصية واضحة وغير مهادنة.",

    en: "An original artwork by Talib Jabbar executed in black ink with a bold expressive approach. The composition presents a fragmented female form intertwined with organic, wood-like elements in a dense vertical structure. Through aggressive linework and psychological tension, the piece creates a striking visual presence, making it well suited for serious collectors and art spaces seeking a work with strong identity and emotional force.",

    ku: "ئەم کارە هونەرییەی ڕەسەن بۆ Talib Jabbar بە حەبری ڕەش و بە شێوازێکی دەربڕینی توند ئەنجامدراوە. لە تابلۆکەدا شێوەیەکی ژنانە لەگەڵ توخمە ئۆرگانیکی و دارئاسا تێکەڵ بووە و پێکهاتەیەکی ستوونی پڕهێز دروست کردووە. هێڵە توند و چڕەکان هەستێک لە پەستان و هێزی دەروونی دروست دەکەن، بۆیە کارێکی بەهێزە بۆ کۆکردنەوەی هونەری تایبەت."
  },
  ...
  images: [
    cld("hoa-art-348_yw4she"),
    cld("hoa-art-348-1_stml2j")
  ],

  keywords: "لوحة فنية, طالب جبار, لوحة تعبيرية, حبر اسود, جسد انثوي, فن عراقي, talib jabbar, expressionist painting, ink drawing"
},
{
  id: "HOA-ART-349",
  category: {
  ...
  name: {
    ar: "الرؤيا المجنحة – طالب جبار",
    en: "Winged Vision – Talib Jabbar",
    ku: "بینینی باڵدار – Talib Jabbar"
  },
  ...
  desc: {
    ar: "عمل فني أصلي للفنان طالب جبار منفذ بالحبر الأسود بأسلوب تعبيري يميل إلى الرمزية والسريالية. تتشكل اللوحة من تكوين مركب يجمع بين شخصية بشرية جالسة وسط عناصر معمارية وعضوية، بينما يظهر فوقها حصان مجنح في حركة صاعدة تشبه الرؤيا أو الحلم. الخطوط الحرة والكثيفة تمنح العمل طاقة ديناميكية واضحة، وتخلق توازناً بين الواقع والخيال. قطعة مميزة لمحبي الأعمال التعبيرية التي تحمل طبقات من المعنى والرمز.",

    en: "An original artwork by Talib Jabbar executed in black ink with a symbolic, surreal expressive style. The composition brings together a seated human figure surrounded by architectural and organic elements, while a winged horse rises above the scene like a vision or dream. The energetic linework creates movement and tension, making this piece a striking addition to collections that appreciate expressive and symbolic drawing.",

    ku: "ئەم تابلۆیەی ڕەسەن بۆ Talib Jabbar بە حەبری ڕەش دروستکراوە و شێوازێکی دەربڕینی نزیک لە سیمبولیزم و سۆریالیزم هەیە. لە ناو تابلۆکەدا شەخسیەکی مرۆڤی لە نێوان توخمە بینایی و ئۆرگانیکی دانیشتووە، لە کاتێکدا ئەسپێکی باڵدار لە سەرەوە بە شێوەیەکی هەڵکشاو وەک بینینێک یان خەونێک دەرکەوتووە."
  },
  ...
  images: [
    cld("hoa-art-349_l6x1zx")
  ],

  keywords: "لوحة فنية, طالب جبار, حصان مجنح, فن تعبيري, رسم بالحبر, فن عراقي, talib jabbar painting, surreal ink drawing"
},
{
  id: "HOA-ART-350",
  ...
  name: {
    ar: "طالب جبار — رسم بالحبر",
    en: "Talib Jabbar — Ink Drawing",
    ku: "Talib Jabbar — Drawing"
  },
  ...
  desc: {
    ar: "عمل فني أصلي للفنان العراقي طالب جبار منفذ بالحبر الأسود على الورق بأسلوب تعبيري غني بالتفاصيل. يعتمد العمل على خطوط حرة وكثيفة تبني تكويناً معقداً من الأشكال البشرية والحيوانية المتداخلة في حركة ديناميكية عمودية. يظهر في التكوين حصان مجنح وعناصر رمزية متعددة تتشابك مع هيئة بشرية في بناء بصري متوتر يقترب من السريالية التعبيرية. هذا النوع من الرسوم بالحبر يمثل جانباً مهماً من التجارب الخطية لدى الفنان.",

    en: "An original ink drawing by Iraqi artist Talib Jabbar executed in black ink on paper. The composition features dense expressive linework forming an intricate vertical structure of intertwined human and animal figures. A winged horse and symbolic elements emerge within the dynamic composition, creating a surreal expressive atmosphere characteristic of the artist’s graphic explorations.",

    ku: "ئەم کارە هونەرییە تابلۆیەکی ڕەسەنی Talib Jabbar ـە کە بە حەبری ڕەش لەسەر کاغەز دروستکراوە. تابلۆکە بە هێڵە چڕ و ئازادەکان پێکهاتەیەکی ئاڵۆز دروست دەکات کە تێکەڵی شێوەی مرۆڤی و ئاژەڵییە و هەستێکی دەربڕینی نزیک لە سۆریالیزم دروست دەکات."
  },
  ...
  images: [
    cld("hoa-art-350_vhzk2g")
  ],

  keywords: "طالب جبار, فن عراقي, رسم بالحبر, لوحة حبر, talib jabbar, iraqi art, ink drawing"
},
