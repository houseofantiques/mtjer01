export const FURNITURE_PRODUCTS = [
  {
    ...
    status: "available",
    keywords: {
      ar: "مروحة تراثية, مروحة كهربائية قديمة, أجهزة قديمة, أثاث تراثي, ديكور صناعي, مروحة حديد",
      en: "vintage electric fan, heritage fan, iron fan, industrial decor, antique appliance, collectible fan",
      ku: "پەنکەی میراثی, پەنکەی کارەبایی, ئامێری کۆن, دیکۆری پیشەسازی, پەنکەی ئاسنی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-028_p2js0f"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-028_p2js0f"
  },
  {
    id: "HOA-GRM-026",
    category: {
    ...
    keywords: {
      ...
      en: "gramophone radio, antique radio, wooden gramophone, record cabinet, heritage audio, vintage furniture",
      ku: "گرامافۆن, ڕادیۆی کۆن, ئاسطوانە, دۆڵابی ئاسطوانە, پارچەی میراثی, داری لوکس"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-grm-026_xbttfp"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-grm-026_xbttfp"
  },
  {
    id: "HOA-BOX-043",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "صندوق هندي, صندوق خشبي, تطعيم نحاس, أثاث تراثي, تخزين فاخر, ديكور شرقي",
      en: "indian chest, wooden chest, copper inlay box, heritage storage, luxury decor, oriental furniture",
      ku: "سندوقی هندی, سندوقی دار, مسی دەستی, کەلوپەلی میراثی, دیکۆری ڕۆژهەڵاتی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-box-043_qiws3e"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-box-043_qiws3e"
  },
  {
    id: "HOA-WOD-045",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "طقم طاولات, طاولات خشبية, أثاث عملي, طقم أثاث, طاولات جانبية, ديكور منزلي",
      en: "wooden table set, side tables, practical furniture, home decor, nesting tables, wood furniture",
      ku: "سێتی مێز, مێزی دار, کەلوپەلی کارامە, مێزی لاوەکی, دیکۆری ماڵ"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoh-wood-045_czwfhh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoh-wood-045_czwfhh"
  },
  {
    id: "HOA-TRL-015",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "مكنة خياطة, فراشة, آلة خياطة قديمة, أثاث تراثي, أدوات منزلية قديمة, مقتنيات عراقية",
      en: "butterfly sewing machine, vintage sewing machine, heritage appliance, Iraqi household item, antique sewing, collectible machine",
      ku: "ئامێری دوورین, فڕۆکە, ئامێری کۆن, کەلوپەلی میراثی, پارچەی عێراقی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-015_jdsh0y"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-015_jdsh0y",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "صندوق نحاس, أنتيكة, صندوق مزخرف, تخزين تراثي, تحفة معدنية, ديكور كلاسيكي",
      en: "antique copper box, ornate metal box, heritage storage, decorative copper, vintage decor, collectible box",
      ku: "سندوقی نەحاس, ئەنتیک, سندوقی ڕازاو, پارچەی میراثی, دیکۆری کلاسیکی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-024_e2tji9",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-024_e2tji9"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-slv-024_e2tji9",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "كونسول مدخل, كرسيين, أثاث تراثي, طاولة منحوتة, ديكور شرقي, جلسة فاخرة",
      en: "console entrance set, carved wooden table, two chairs, heritage furniture, oriental decor, luxury seating",
      ku: "کۆنسوڵ, دوو کورسی, کەلوپەلی میراثی, مێزی نەخشکراو, دیکۆری ڕۆژهەڵاتی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-037_lqn2es"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-037_lqn2es",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "آلة طباعة, النجار, طابعة عراقية, مكتب كلاسيكي, مقتنيات تراثية, ديكور مكتبي",
      en: "iraqi typewriter, al-najjar, vintage typewriter, office decor, collectible machine, heritage technology",
      ku: "ماشینی نووسین, نەجّار, طابعة عێراقی, ئۆفیسی کلاسیکی, پارچەی میراثی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-105-jpg_oswyzv",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/DSC_8743_swizz6",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/DSC_8744_zefhzy"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-trl-105-jpg_oswyzv",
  ...
  },
  {
    ...
    sourceCategory: "ساعات وأثاث خشبي",
    name: {
    ...
    status: "available",
    keywords: {
      ar: "ساعة جدارية, ساعة إنكليزية, ساعة خشبية, بندول, ساعة أنتيك, ديكور تراثي",
      en: "english wall clock, antique clock, wooden pendulum clock, heritage decor, mechanical clock, vintage timepiece",
      ku: "کاتژمێری دیواری, کاتژمێری ئینگلیزی, کاتژمێری دار, پێندۆڵ, پارچەی کۆن"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-119_asf2kz"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-119_asf2kz",
    createdAt: "2026-01-09"
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "ساعة جدارية, ساعة رومانية, ساعة خشبية, أثاث كلاسيكي, بندول داخلي, قطعة متحفية",
      en: "wooden wall clock, roman numeral clock, antique pendulum clock, classic decor, museum display, heritage clock",
      ku: "کاتژمێری دیواری, ژمارەی ڕۆمانی, کاتژمێری دار, پێندۆڵ, پارچەی مێژوویی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-118_uayr2i"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-118_uayr2i",
    createdAt: "2026-01-09"
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "ساعة أوروبية, ساعة جدارية, ساعة خشبية, بندول مزخرف, ديكور كلاسيكي, ساعة أنتيك",
      en: "european wall clock, antique wooden clock, ornate pendulum clock, classical decor, mechanical timepiece, vintage wall clock",
      ku: "کاتژمێری ئەورووپی, کاتژمێری دیواری, پێندۆڵی ڕازاو, دیکۆری کلاسیکی, پارچەی کۆن"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-120_svjtuw"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-120_svjtuw",
    createdAt: "2026-01-09"
  },
  {
    id: "HOA-WOOD-120",
    ...
    status: "available",
    keywords: {
      ar: "مراية أرضية, إطار خشبي, مراية مزخرفة, أثاث تراثي, ديكور فاخر, مراية كلاسيكية",
      en: "floor mirror, ornate wooden mirror, heritage furniture, classic decor, antique mirror, carved frame",
      ku: "ئاوێنەی ئەساسی, چوارچێوەی دار, ئاوێنەی ڕازاو, دیکۆری کلاسیکی, پارچەی میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-120_vp0d9n"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-120_vp0d9n",
    material: {
  ...
  },
  {
    ...
    sourceCategory: "أثاث خشبي",
    name: {
      ar: "مقعد خشبي أنتيك مزدوج الطراز الكلاسيكي",
      en: "Antique Double Wooden Bench – Classic Style",
      ku: "کورسی دارەکی کۆن دووشوێن بە شێوازی کلاسیکی"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "مقعد خشبي, بنش أنتيك, أثاث كلاسيكي, مقعد مزدوج, ديكور تراثي, وسائد أصلية",
      en: "antique wooden bench, double seat bench, classic furniture, heritage seating, vintage wood bench, upholstered antique",
      ku: "مقعدی دار, بنشی کۆن, کەلوپەلی کلاسیکی, دووشوێن, پارچەی میراثی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-140-1_to2ktw",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-140_vfrqk6",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-140-2_yjcgbx"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-140-1_to2ktw"
  },
  {
    id: "HOA-WOOD-142",
    category: {
    ...
    name: {
      ar: "طاولة خشبية عالية أنتيك",
      en: "Antique High Wooden Table",
      ku: "مێزی دارەکی بەرز کۆن"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "طاولة عالية, طاولة خشبية, طاولة عرض, أثاث أنتيك, مائدة جانبية, ديكور تراثي",
      en: "high wooden table, antique side table, display table, heritage furniture, carved legs, classic wood table",
      ku: "مێزی بەرز, مێزی دار, مێزی پیشاندان, پارچەی کۆن, دیکۆری میراثی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-142_lodnt0"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-142_lodnt0"
  },
  {
    id: "HOA-WOOD-129",
    category: {
    ...
    name: {
      ar: "مقعد خشبي منحوت على شكل فيل",
      en: "Hand-Carved Wooden Elephant Stool",
      ku: "کورسی دارەکی دەست‌تاشراو بە شێوەی فیل"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "مقعد فيل, مقعد خشبي, نحت يدوي, أثاث أنتيك, ديكور تراثي, تحفة خشبية",
      en: "elephant stool, carved wooden stool, antique decor, hand carved furniture, heritage piece, wooden collectible",
      ku: "کورسی فیل, کورسی دار, نحتی دەستی, کەلوپەلی کۆن, پارچەی میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-129_ir4wft",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-129-1_fz1mgn"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-129_ir4wft"
  },
  {
    id: "HOA-WOOD-135",
    category: {
    ...
    name: {
      ar: "منفضة سكائر خشبية أنتيك",
      en: "Antique Wooden Standing Ashtray",
      ku: "خۆڵدانەی جگەرە دارەکی کۆن"
    },
    desc: {
    ...
    keywords: {
      ...
      en: "wooden ashtray, antique ashtray, heritage decor, carved wood piece, classic accessory, vintage decor",
      ku: "خۆڵدانەی دار, ئەنتیک, پارچەی دیکۆری, میراثی, پارچەی چاوپێکەوتن"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-135_xzmsty"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-wood-135_xzmsty"
  },
  {
    id: "HOA-FINE-146",
    category: {
    ...
    name: {
      ar: "ساعة أرضية منحوتة فنية",
      en: "Carved Artistic Floor Clock",
      ku: "کاتژمێری سەربەخۆی دەست‌تاشراو"
    },
    desc: {
    ...
    status: "available",
    keywords: {
      ar: "ساعة أرضية, ساعة منحوتة, أثاث فني, ساعة رومانية, قطعة متحفية, ديكور فاخر",
      en: "floor clock, carved clock, artistic furniture, museum style decor, roman numeral clock, statement piece",
      ku: "کاتژمێری سەربەخۆ, کاتژمێری نەخشکراو, کەلوپەلی هونەری, پارچەی فاخر, مۆزەیی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-146_buidkf",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-146-1_do6jyk",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-146-2_lyfo8p",
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-146-3_mdptwl"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-fine-146_buidkf"
  },
  {
    id: "HOA-FUR-121",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "مراية فكتورية, مراية أفقية, إطار مزخرف, أثاث أوروبي, ديكور كلاسيكي, قطعة فاخرة",
      en: "victorian mirror, horizontal mirror, ornate frame, european furniture, classic decor, luxury wall mirror",
      ku: "ئاوێنەی فیکتۆری, چوارچێوەی ڕازاو, دیکۆری کلاسیکی, پارچەی فاخر, ئەورووپی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-121_u3dbvj"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-cry-121_u3dbvj",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "فاترينا عرض, خزانة زجاج, أثاث خشبي, عرض تحف, ديكور متحفي, فاترينا أنيقة",
      en: "display vitrine, glass cabinet, wooden display cabinet, antique showcase, museum style furniture, elegant storage",
      ku: "فاترینا, خزانەی شووشە, پیشاندانی تحف, کەلوپەلی دار, پارچەی مۆزەیی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-190_luimhh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-190_luimhh",
    material: {
      ar: "خشب طبيعي وزجاج",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "مراية منضدية, إطار معدني, مرآة أنتيك, ديكور طاولة, أثاث صغير, قطعة تراثية",
      en: "tabletop mirror, ornate metal mirror, antique vanity mirror, heritage decor, small furniture accent, classic mirror",
      ku: "ئاوێنەی سەر مێز, چوارچێوەی ئاسنی, ئەنتیک, دیکۆری ناوخۆ, پارچەی میراثی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-210_fytpwh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-210_fytpwh",
    material: {
      ar: "إطار معدني وزجاج",
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "ساعة منضدية, ساعة خشبية, آرت ديكو, ديكور مكتبي, ساعة كلاسيكية, تحفة صغيرة",
      en: "table clock, wooden clock, art deco clock, desk decor, classic timepiece, antique tabletop clock",
      ku: "کاتژمێری سەر مێز, کاتژمێری دار, آرت دیکۆ, پارچەی کۆن, دیکۆری مێز"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-195_cwjcn2"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-195_cwjcn2",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "كونسول مدخل, أثاث أنتيك, نحت يدوي, خشب طبيعي, ديكور أوروبي, قطعة فاخرة",
      en: "entry console, antique wooden console, hand carved furniture, european decor, luxury hall table, heritage piece",
      ku: "کۆنسۆڵ, کەلوپەلی ئەنتیک, نحتی دەستی, داری سرووشتی, دیکۆری ئەورووپی"
    },
    featured: true,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-205_mf6qlp"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-205_mf6qlp",
    material: {
  ...
  },
  {
    ...
    status: "available",
    keywords: {
      ar: "هاتف خشبي, هاتف أنتيك, ديكور كلاسيكي, تحفة تقنية, أثاث وديكور, هاتف قديم",
      en: "wooden telephone, antique phone, classic decor, vintage communication device, heritage technology, collectible phone",
      ku: "تەلەفۆنی دار, ئانتیک, دیکۆری کلاسیکی, پارچەی تەکنەلۆجی, تەلەفۆنی کۆن"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-239_rkmqhf"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-239_rkmqhf"
  },
  {
    id: "HOA-FURN-236",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "طاولة كونسول, رخام, خشب محفور, أثاث أوروبي, أنتيك فاخر, ديكور كلاسيكي",
      en: "antique console table, marble top table, hand carved wood, european antique furniture, luxury decor, statement piece",
      ku: "مێزی کۆنسۆڵ, مەرمەر, داری نەخشکراو, کەلوپەلی ئەورووپی, پارچەی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-236_qchajy"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-236_qchajy"
  },
  {
    id: "HOA-FURN-242",
    category: {
    ...
    keywords: {
      ...
      en: "antique table lamp, ceramic base lamp, vintage lighting, classic decor, fabric shade lamp, heritage interior",
      ku: "چرای مێز, بنەمای خەزەف, ڕووناکی ئانتیک, دیکۆری کلاسیکی, ئاباجور"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-242_mqjps4"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-242_mqjps4"
  },
  {
    id: "HOA-FURN-245",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فاترينة أنتيك, خزانة عرض, خشب محفور, عرض تحف, أثاث فاخر, قطعة متحفية",
      en: "antique display cabinet, hand carved vitrine, wooden showcase, collectible display, museum furniture, luxury cabinet",
      ku: "فاترینەی ئانتیک, خزانەی پیشاندان, داری نەخشکراو, پارچەی مۆزەیی, کەلوپەلی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-245_qhnsy6"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-245_qhnsy6"
  },
  {
    id: "HOA-FURN-256",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "هاتف دوّار, هاتف أسود, تحف تقنية, ديكور نوستالجي, أثاث كلاسيكي, هاتف قديم",
      en: "rotary telephone, black antique phone, nostalgic decor, vintage technology, classic office decor, collectible phone",
      ku: "تەلەفۆنی گەردی, تەلەفۆنی ڕەش, پارچەی نوستالژی, تەکنەلۆژیی کۆن, دیکۆری کلاسیکی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-256_r7yht3"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-256_r7yht3"
  },
  {
    id: "HOA-FURN-252",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "زوج كراسي, كراسي أنتيك, أثاث أوروبي, كراسي كلاسيكية, قماش منجد, ديكور رسمي",
      en: "pair of antique chairs, european chairs, classic seating, upholstered antique chairs, heritage furniture, formal room decor",
      ku: "دوو کورسی, کورسیی ئانتیک, کەلوپەلی ئەورووپی, دانیشتنەوەی کلاسیکی, پارچەی میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-252_coggct"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-252_coggct"
  },
  {
    id: "HOA-FURN-266",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "قاطع خشبي, بارتيشن, أثاث شرقي, خشب محفور, ديكور تراثي, فاصل غرف",
      en: "wooden room divider, antique screen, eastern decor, hand carved partition, heritage furniture, cultural statement piece",
      ku: "پارتیشن, قاطعی دار, کەلوپەلی ڕۆژهەڵاتی, داری نەخشکراو, دیکۆری میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-266_zxupsl"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-266_zxupsl"
  },
  {
    id: "HOA-FURN-271",
    category: {
    ...
    keywords: {
      ...
      en: "british wall clock, wooden pendulum clock, classic furniture, heritage decor, tall wall clock, vintage interior",
      ku: "کاتژمێری بەریتانی, کاتژمێری دیواری, پێندۆڵ, کەلوپەلی کلاسیکی, پارچەی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-271_ik0j6i"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-271_ik0j6i"
  },
  {
    id: "HOA-FURN-269",
    category: {
    ...
    keywords: {
      ...
      en: "display table, wooden table, classic furniture, antique display stand, interior decor, side table",
      ku: "مێزی پیشاندان, مێزی دار, کەلوپەلی کلاسیکی, مێزی شوێنەوار, دیکۆری ناوخۆ"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-269_f8leqh"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-269_f8leqh"
  },
  {
    id: "HOA-FURN-273",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "مغسلة خشبية, مغسلة قديمة, مرآة وحوض, أثاث أوروبي, قطعة نادرة, ديكور تراثي",
      en: "wooden washstand, antique washstand, mirror basin furniture, european heritage decor, rare furniture, ceramic basin set",
      ku: "دەستشووی دار, ئاوینە و حەوز, کەلوپەلی ئەورووپی, پارچەی نادر, دیکۆری میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-273_f0a9hi"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-273_f0a9hi"
  },
  {
    id: "HOA-FURN-268",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "جلسة أرضية, طقم جلوس, أثاث شرقي, خشب منحوت, مجلس فاخر, ديكور تراثي",
      en: "floor seating set, carved wood furniture, oriental seating, majlis furniture, luxury heritage decor, hand carved chairs",
      ku: "دانیشتنەوەی زەوی, سێتی جلوس, کەلوپەلی ڕۆژهەڵاتی, داری نەخشکراو, مەجلیسی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-268_dwufuq"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-268_dwufuq"
  },
  {
    id: "HOA-FURN-290",
    category: {
    ...
    keywords: {
      ...
      en: "wooden library, floor bookcase, hand carved wood, heritage furniture, luxury bookshelf, antique cabinet",
      ku: "کتێبخانەی دار, کتێبخانەی سەر زەوی, داری نەخشکراو, کەلوپەلی میراثی, پارچەی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-290_k4f8sb"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-290_k4f8sb"
  },
  {
    id: "HOA-FURN-291",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فاترينا خشبية, خزانة عرض, واجهات زجاج, أدراج, أثاث كلاسيكي, عرض تحف",
      en: "wooden display cabinet, glass vitrine, classic storage, collectible showcase, heritage furniture, floor cabinet",
      ku: "فاترینای دار, خزانەی پیشاندان, شیشە, خانە, کەلوپەلی کلاسیکی, پارچەی میراثی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-291_cgi2hb"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-291_cgi2hb"
  },
  {
    id: "HOA-FURN-281",
    category: {
    ...
    status: "available",
    keywords: {
      ar: "فاترينا مزدوجة, خزانة عرض كبيرة, أثاث كلاسيكي, واجهات زجاجية, عرض أواني, ديكور فاخر",
      en: "double display cabinet, wooden vitrine, glass door cabinet, classic furniture, elegant showcase, heritage storage",
      ku: "فاترینای دووبەش, خزانەی پیشاندان, دەرگای شیشە, کەلوپەلی کلاسیکی, پارچەی فاخر"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-281_kgpksb"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-281_kgpksb"
  },
  {
    id: "HOA-FURN-292",
    category: {
    ...
    keywords: {
      ...
      en: "bridal chest, english chest, ceramic inlay furniture, heritage storage, traditional trunk, antique decor",
      ku: "محملی بووک, سندوقی بووک, کەلوپەلی ئینگلیزی, سێرامیک, پارچەی مێژوویی"
    },
    featured: false,
    auction: false,
    images: [
      "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-292_flpnso"
    ],
    image: "https://res.cloudinary.com/dyqdfbaln/image/upload/f_auto,q_auto,w_1200/hoa-furn-292_flpnso"
  }
];